...
{
	/// <summary>
	/// Provides additional design-time functionality for the <see cref="NuGenTaskBox"/>.
	/// </summary>
	public class NuGenTaskBoxDesigner : ParentControlDesigner
	{
		/// <summary>
		...
		public override SelectionRules SelectionRules
		{
			get
			{
				if (((NuGenTaskBox)base.Component).Collapsed)
				{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenTaskBoxDesigner"/> class.
		/// </summary>
		public NuGenTaskBoxDesigner()
		{
		}
	}
}
