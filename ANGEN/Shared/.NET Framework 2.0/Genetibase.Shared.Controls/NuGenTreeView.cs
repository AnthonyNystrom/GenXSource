...
{
	/// <summary>
	/// Represents a <see cref="T:System.Windows.Forms.TreeView"/> that is able to display check boxes on
	/// specific nodes.
	/// </summary>
	[ToolboxItem(true)]
	[ToolboxBitmap(typeof(NuGenTreeView), "Resources.NuGenIcon.png")]
	[Designer("Genetibase.Shared.Controls.Design.NuGenTreeViewDesigner")]
	[System.ComponentModel.DesignerCategory("Code")]
	public partial class NuGenTreeView : TreeView, INuGenImageListProvider
	{
		...
		private INuGenTreeViewDragDropService _dragDropService;
		...
		private INuGenTreeNodeSorter _treeNodeSorter;
