...
Partial Class MainForm
    ...
    Private Sub InitializeComponent()
        ...
        Me._tooltip.SetToolTip(Me._button, New Genetibase.[Shared].Controls.NuGenToolTipInfo("Microsoft Office 2007 like ToolTip", CType(resources.GetObject("_button.ToolTip"), System.Drawing.Image), "Use our user-friendly tool-tip designer with in-place preview ability.", "Press F1 for more help", CType(resources.GetObject("_button.ToolTip1"), System.Drawing.Image), "You can also specify custom tool-tip size if you are not satisfied with auto-size" & _
