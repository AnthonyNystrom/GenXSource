...
namespace Genetibase.NuGenVisiCalc
{
	...
	internal sealed partial class MainForm : VisiCalcFormBase
	{
		...
		protected override void OnFormClosing(FormClosingEventArgs e)
		{
			...
			Settings.Default.PropertiesForm_Visible = _propertiesButton.Checked;
			Settings.Default.ToolboxForm_Visible = _toolboxButton.Checked;
			Settings.Default.OutputForm_Visible = _outputButton.Checked;
