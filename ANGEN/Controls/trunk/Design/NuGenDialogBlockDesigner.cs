...
namespace Genetibase.Controls.Design
{
	...
	/// </summary>
	class NuGenDialogBlockDesigner : ParentControlDesigner
	{
		#region Declarations

		/// <summary>
		/// Determines the <see cref="T:NuGenDialogBlock"/> currently being designed.
		/// </summary>
		private NuGenDialogBlock dialogBlock = null;
		...
		public override void Initialize(System.ComponentModel.IComponent component)
		{
			...
			this.dialogBlock = (NuGenDialogBlock)component;
		}
		...
		private void InitializeDialogButton(Button btn)
		{
			...
			if (btn != null)
			{
				...
				btn.Top = this.dialogBlock.Height / 2 - btn.Height / 2;
