...
{
	/// <summary>
	/// Provides a list of standard values for <see cref="System.Diagnostics.PerformanceCounter.InstanceName"/> like property.
	/// </summary>
	public class NuGenInstanceNameConverter : TypeConverter
	{
		/// <summary>
		/// Returns
