/* -----------------------------------------------
 * NuGenCurrentPercentProcessorTimeMeter.cs
...
namespace Genetibase.UI.NuGenMeters.JobObject
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenCurrentPercentProcessorTimeMeter : NuGenMeterBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenCurrentPercentProcessorTimeMeter"/> class.
		/// </summary>
		public NuGenCurrentPercentProcessorTimeMeter()
		{
			InitializeComponent();
		}
