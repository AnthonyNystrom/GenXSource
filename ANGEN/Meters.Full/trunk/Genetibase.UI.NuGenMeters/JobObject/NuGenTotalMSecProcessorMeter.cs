/* -----------------------------------------------
 * NuGenTotalMSecProcessorMeter.cs
...
namespace Genetibase.UI.NuGenMeters.JobObject
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenTotalMSecProcessorMeter : NuGenMeterBase
	{
		#region Declarations
		...
		private PerformanceCounter counter = cat.GetCounter(en.TotalMSecProcessor);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenTotalMSecProcessorMeter"/> class.
		/// </summary>
		public NuGenTotalMSecProcessorMeter()
		{
			InitializeComponent();
		}
