/* -----------------------------------------------
 * NuGenTotalMSecKernelModeMeter.cs
...
namespace Genetibase.UI.NuGenMeters.JobObject
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenTotalMSecKernelModeMeter : NuGenMeterBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenTotalMSecKernelModeMeter"/> class.
		/// </summary>
		public NuGenTotalMSecKernelModeMeter()
		{
			InitializeComponent();
		}
