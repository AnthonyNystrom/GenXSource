/* -----------------------------------------------
 * NuGenProcessCountActiveMeter.cs
...
namespace Genetibase.UI.NuGenMeters.JobObject
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenProcessCountActiveMeter : NuGenMeterBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenProcessCountActiveMeter"/> class.
		/// </summary>
		public NuGenProcessCountActiveMeter()
		{
			InitializeComponent();
		}
