/* -----------------------------------------------
 * NuGenThisPeriodMSecKernelModeMeter.cs
...
namespace Genetibase.UI.NuGenMeters.JobObject
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenThisPeriodMSecKernelModeMeter : NuGenMeterBase
	{
		#region Declarations
		...
		private PerformanceCounter counter = cat.GetCounter(en.ThisPeriodMSecKernelMode);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenThisPeriodMSecKernelModeMeter"/> class.
		/// </summary>
		public NuGenThisPeriodMSecKernelModeMeter()
		{
			InitializeComponent();
		}
