/* -----------------------------------------------
 * NuGenProcessCountTotalMeter.cs
...
namespace Genetibase.UI.NuGenMeters.JobObject
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenProcessCountTotalMeter : NuGenMeterBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenProcessCountTotalMeter"/> class.
		/// </summary>
		public NuGenProcessCountTotalMeter()
		{
			InitializeComponent();
		}
