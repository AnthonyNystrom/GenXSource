/* -----------------------------------------------
 * NuGenCurrentPercentKernelModeTimeMeter.cs
...
namespace Genetibase.UI.NuGenMeters.JobObject
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenCurrentPercentKernelModeTimeMeter : NuGenMeterBase
	{
		#region Declarations
		...
		private PerformanceCounter counter = cat.GetCounter(en.CurrentPercentKernelModeTime);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenCurrentPercentKernelModeTimeMeter"/> class.
		/// </summary>
		public NuGenCurrentPercentKernelModeTimeMeter()
		{
			InitializeComponent();
		}
