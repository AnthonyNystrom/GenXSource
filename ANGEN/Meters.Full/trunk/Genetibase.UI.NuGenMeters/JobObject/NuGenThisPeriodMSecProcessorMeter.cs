/* -----------------------------------------------
 * NuGenThisPeriodMSecProcessorMeter.cs
...
namespace Genetibase.UI.NuGenMeters.JobObject
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenThisPeriodMSecProcessorMeter : NuGenMeterBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenThisPeriodMSecProcessorMeter"/> class.
		/// </summary>
		public NuGenThisPeriodMSecProcessorMeter()
		{
			InitializeComponent();
		}
