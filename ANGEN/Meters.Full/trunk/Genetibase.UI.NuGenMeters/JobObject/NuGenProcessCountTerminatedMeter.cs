/* -----------------------------------------------
 * NuGenProcessCountTerminatedMeter.cs
...
namespace Genetibase.UI.NuGenMeters.JobObject
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenProcessCountTerminatedMeter : NuGenMeterBase
	{
		#region Declarations
		...
		private PerformanceCounter counter = cat.GetCounter(en.ProcessCountTerminated);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenProcessCountTerminatedMeter"/> class.
		/// </summary>
		public NuGenProcessCountTerminatedMeter()
		{
			InitializeComponent();
		}
