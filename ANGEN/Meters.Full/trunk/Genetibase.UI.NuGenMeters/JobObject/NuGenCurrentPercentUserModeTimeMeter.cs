/* -----------------------------------------------
 * NuGenCurrentPercentUserModeTimeMeter.cs
...
namespace Genetibase.UI.NuGenMeters.JobObject
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenCurrentPercentUserModeTimeMeter : NuGenMeterBase
	{
		#region Declarations
		...
		private PerformanceCounter counter = cat.GetCounter(en.CurrentPercentUserModeTime);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenCurrentPercentUserModeTimeMeter"/> class.
		/// </summary>
		public NuGenCurrentPercentUserModeTimeMeter()
		{
			InitializeComponent();
		}
