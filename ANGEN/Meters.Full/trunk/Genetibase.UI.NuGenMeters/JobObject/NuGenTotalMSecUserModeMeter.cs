/* -----------------------------------------------
 * NuGenTotalMSecUserModeMeter.cs
...
namespace Genetibase.UI.NuGenMeters.JobObject
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenTotalMSecUserModeMeter : NuGenMeterBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenTotalMSecUserModeMeter"/> class.
		/// </summary>
		public NuGenTotalMSecUserModeMeter()
		{
			InitializeComponent();
		}
