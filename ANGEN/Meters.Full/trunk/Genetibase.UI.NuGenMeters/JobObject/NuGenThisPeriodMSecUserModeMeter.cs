/* -----------------------------------------------
 * NuGenThisPeriodMSecUserModeMeter.cs
...
namespace Genetibase.UI.NuGenMeters.JobObject
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenThisPeriodMSecUserModeMeter : NuGenMeterBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenThisPeriodMSecUserModeMeter"/> class.
		/// </summary>
		public NuGenThisPeriodMSecUserModeMeter()
		{
			InitializeComponent();
		}
