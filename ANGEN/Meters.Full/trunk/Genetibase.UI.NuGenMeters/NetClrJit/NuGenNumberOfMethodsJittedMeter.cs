/* -----------------------------------------------
 * NuGenNumberOfMethodsJittedMeter.cs
...
namespace Genetibase.UI.NuGenMeters.NetClrJit
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenNumberOfMethodsJittedMeter : NuGenMeterBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenNumberOfMethodsJittedMeter"/> class.
		/// </summary>
		public NuGenNumberOfMethodsJittedMeter()
		{
			InitializeComponent();
		}
