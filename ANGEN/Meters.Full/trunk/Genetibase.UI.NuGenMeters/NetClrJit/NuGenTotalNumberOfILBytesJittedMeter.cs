/* -----------------------------------------------
 * NuGenTotalNumberOfILBytesJittedMeter.cs
...
namespace Genetibase.UI.NuGenMeters.NetClrJit
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenTotalNumberOfILBytesJittedMeter : Genetibase.UI.NuGenMeters.NuGenByteMeterBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenTotalNumberOfILBytesJittedMeter"/> class.
		/// </summary>
		public NuGenTotalNumberOfILBytesJittedMeter()
		{
			InitializeComponent();
		}
