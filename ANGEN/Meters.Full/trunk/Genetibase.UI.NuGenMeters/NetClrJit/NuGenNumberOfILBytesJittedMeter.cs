/* -----------------------------------------------
 * NuGenNumberOfILBytesJittedMeter.cs
...
namespace Genetibase.UI.NuGenMeters.NetClrJit
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenNumberOfILBytesJittedMeter : Genetibase.UI.NuGenMeters.NuGenByteMeterBase
	{
		#region Declarations
		...
		private PerformanceCounter counter = cat.GetCounter(en.NumberOfILBytesJitted);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenNumberOfILBytesJittedMeter"/> class.
		/// </summary>
		public NuGenNumberOfILBytesJittedMeter()
		{
			InitializeComponent();
		}
