/* -----------------------------------------------
 * NuGenILBytesJittedPerSecGraph.cs
...
namespace Genetibase.UI.NuGenMeters.NetClrJit
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenILBytesJittedPerSecGraph : NuGenGraphBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenILBytesJittedPerSecGraph"/> class.
		/// </summary>
		public NuGenILBytesJittedPerSecGraph()
		{
			InitializeComponent();
		}
