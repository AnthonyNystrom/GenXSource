/* -----------------------------------------------
 * NuGenStandardJitFailuresMeter.cs
...
{
	/// <summary>
	/// .NET CLR Jit -> StandardJitFailures
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenStandardJitFailuresMeter : NuGenMeterBase
	{
		#region Declarations
		...
		private PerformanceCounter counter = cat.GetCounter(en.StandardJitFailures);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenStandardJitFailuresMeter"/> class.
		/// </summary>
		public NuGenStandardJitFailuresMeter()
		{
			InitializeComponent();
		}
