...
namespace Genetibase.UI.NuGenMeters.NetClrJit
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenPercentTimeInJitMeter : NuGenMeterBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenPercentTimeInJitMeter"/> class.
		/// </summary>
		public NuGenPercentTimeInJitMeter()
		{
			InitializeComponent();
		}
