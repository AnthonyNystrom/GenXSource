...
{
	/// <summary>
    /// Defines a designer for the <c>Genetibase.UI.NuGenMeters.NuGenGraphBase</c> class.
	/// </summary>
	public class NuGenGraphBaseDesigner : NuGenGraphGenericDesigner
	{
		/// <summary>
