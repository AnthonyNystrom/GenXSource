...
namespace Genetibase.UI.NuGenMeters.PrintQueue
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenNotReadyErrorsMeter : NuGenMeterBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenNotReadyErrorsMeter"/> class.
		/// </summary>
		public NuGenNotReadyErrorsMeter()
		{
			InitializeComponent();
		}
