...
namespace Genetibase.UI.NuGenMeters.PrintQueue
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenNotReadyErrorsGraph : NuGenGraphBase
	{
		#region Declarations
		...
		private PerformanceCounter counter = cat.GetCounter(en.NotReadyErrors);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenNotReadyErrorsGraph"/> class.
		/// </summary>
		public NuGenNotReadyErrorsGraph()
		{
			InitializeComponent();
		}
