/* -----------------------------------------------
 * NuGenTotalPagesPrintedGraph.cs
...
namespace Genetibase.UI.NuGenMeters.PrintQueue
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenTotalPagesPrintedGraph : NuGenGraphBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenTotalPagesPrintedGraph"/> class.
		/// </summary>
		public NuGenTotalPagesPrintedGraph()
		{
			InitializeComponent();
		}
