...
namespace Genetibase.UI.NuGenMeters.PrintQueue
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenTotalJobsPrintedMeter : NuGenMeterBase
	{
		#region Declarations
		...
		private PerformanceCounter counter = cat.GetCounter(en.TotalJobsPrinted);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenTotalJobsPrintedMeter"/> class.
		/// </summary>
		public NuGenTotalJobsPrintedMeter()
		{
			InitializeComponent();
		}
