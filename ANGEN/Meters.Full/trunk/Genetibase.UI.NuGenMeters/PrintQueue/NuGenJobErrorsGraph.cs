...
namespace Genetibase.UI.NuGenMeters.PrintQueue
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenJobErrorsGraph : NuGenGraphBase
	{
		#region Declarations
		...
		private PerformanceCounter counter = cat.GetCounter(en.JobErrors);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenJobErrorsGraph"/> class.
		/// </summary>
		public NuGenJobErrorsGraph()
		{
			InitializeComponent();
		}
