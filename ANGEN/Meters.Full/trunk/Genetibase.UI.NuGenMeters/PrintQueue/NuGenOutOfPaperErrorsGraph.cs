...
namespace Genetibase.UI.NuGenMeters.PrintQueue
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenOutOfPaperErrorsGraph : NuGenGraphBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenOutOfPaperErrorsGraph"/> class.
		/// </summary>
		public NuGenOutOfPaperErrorsGraph()
		{
			InitializeComponent();
		}
