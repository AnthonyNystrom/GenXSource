...
namespace Genetibase.UI.NuGenMeters.PrintQueue
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenMaxJobsSpoolingGraph : NuGenGraphBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenMaxJobsSpoolingGraph"/> class.
		/// </summary>
		public NuGenMaxJobsSpoolingGraph()
		{
			InitializeComponent();
		}
