/* -----------------------------------------------
 * NuGenBytesPrintedPerSecMeter.cs
...
namespace Genetibase.UI.NuGenMeters.PrintQueue
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenBytesPrintedPerSecMeter : Genetibase.UI.NuGenMeters.NuGenByteMeterBase
	{
		#region Declarations
		...
		private PerformanceCounter counter = cat.GetCounter(en.BytesPrintedPerSec);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenBytesPrintedPerSecMeter"/> class.
		/// </summary>
		public NuGenBytesPrintedPerSecMeter()
		{
			InitializeComponent();
		}
