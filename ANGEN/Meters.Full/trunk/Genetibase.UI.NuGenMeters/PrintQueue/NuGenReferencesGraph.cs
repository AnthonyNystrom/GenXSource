...
namespace Genetibase.UI.NuGenMeters.PrintQueue
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenReferencesGraph : NuGenGraphBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenReferencesGraph"/> class.
		/// </summary>
		public NuGenReferencesGraph()
		{
			InitializeComponent();
		}
