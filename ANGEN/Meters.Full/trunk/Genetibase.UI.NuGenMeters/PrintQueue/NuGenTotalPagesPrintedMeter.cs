/* -----------------------------------------------
 * NuGenTotalPagesPrintedMeter.cs
...
namespace Genetibase.UI.NuGenMeters.PrintQueue
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenTotalPagesPrintedMeter : NuGenMeterBase
	{
		#region Declarations
		...
		private PerformanceCounter counter = cat.GetCounter(en.TotalPagesPrinted);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenTotalPagesPrintedMeter"/> class.
		/// </summary>
		public NuGenTotalPagesPrintedMeter()
		{
			InitializeComponent();
		}
