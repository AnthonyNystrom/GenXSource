...
namespace Genetibase.UI.NuGenMeters.PrintQueue
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenTotalJobsPrintedGraph : NuGenGraphBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenTotalJobsPrintedGraph"/> class.
		/// </summary>
		public NuGenTotalJobsPrintedGraph()
		{
			InitializeComponent();
		}
