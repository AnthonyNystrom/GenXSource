...
namespace Genetibase.UI.NuGenMeters.PrintQueue
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenJobErrorsMeter : NuGenMeterBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenJobErrorsMeter"/> class.
		/// </summary>
		public NuGenJobErrorsMeter()
		{
			InitializeComponent();
		}
