...
namespace Genetibase.UI.NuGenMeters.PrintQueue
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenOutOfPaperErrorsMeter : NuGenMeterBase
	{
		#region Declarations
		...
		private PerformanceCounter counter = cat.GetCounter(en.OutOfPaperErrors);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenOutOfPaperErrorsMeter"/> class.
		/// </summary>
		public NuGenOutOfPaperErrorsMeter()
		{
			InitializeComponent();
		}
