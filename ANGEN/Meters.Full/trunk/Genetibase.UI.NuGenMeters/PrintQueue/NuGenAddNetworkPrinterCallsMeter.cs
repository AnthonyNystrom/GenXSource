/* -----------------------------------------------
 * NuGenAddNetworkPrinterCallsMeter.cs
...
namespace Genetibase.UI.NuGenMeters.PrintQueue
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenAddNetworkPrinterCallsMeter : NuGenMeterBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenAddNetworkPrinterCallsMeter"/> class.
		/// </summary>
		public NuGenAddNetworkPrinterCallsMeter()
		{
			InitializeComponent();
		}
