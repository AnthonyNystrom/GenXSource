...
namespace Genetibase.UI.NuGenMeters.PrintQueue
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenJobSpoolingMeter : NuGenMeterBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenJobSpoolingMeter"/> class.
		/// </summary>
		public NuGenJobSpoolingMeter()
		{
			InitializeComponent();
		}
