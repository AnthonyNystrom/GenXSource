...
namespace Genetibase.UI.NuGenMeters.PrintQueue
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenMaxReferencesGraph : NuGenGraphBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenMaxReferencesGraph"/> class.
		/// </summary>
		public NuGenMaxReferencesGraph()
		{
			InitializeComponent();
		}
