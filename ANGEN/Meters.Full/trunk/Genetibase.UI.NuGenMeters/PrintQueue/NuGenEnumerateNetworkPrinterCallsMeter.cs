/* -----------------------------------------------
 * NuGenEnumerateNetworkPrinterCallsMeter.cs
...
namespace Genetibase.UI.NuGenMeters.PrintQueue
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenEnumerateNetworkPrinterCallsMeter : NuGenMeterBase
	{
		#region Declarations
		...
		private PerformanceCounter counter = cat.GetCounter(en.EnumerateNetworkPrinterCalls);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenEnumerateNetworkPrinterCallsMeter"/> class.
		/// </summary>
		public NuGenEnumerateNetworkPrinterCallsMeter()
		{
			InitializeComponent();
		}
