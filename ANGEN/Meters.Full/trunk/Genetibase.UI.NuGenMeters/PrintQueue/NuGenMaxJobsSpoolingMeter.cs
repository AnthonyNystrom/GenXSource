...
namespace Genetibase.UI.NuGenMeters.PrintQueue
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenMaxJobsSpoolingMeter : NuGenMeterBase
	{
		#region Declarations
		...
		private PerformanceCounter counter = cat.GetCounter(en.MaxJobsSpooling);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenMaxJobsSpoolingMeter"/> class.
		/// </summary>
		public NuGenMaxJobsSpoolingMeter()
		{
			InitializeComponent();
		}
