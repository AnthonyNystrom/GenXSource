/* -----------------------------------------------
 * NuGenPercentDiskWriteTimeMeter.cs
...
{
	/// <summary>
	/// Physical Disk -> PercentDiskWriteTime
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenPercentDiskWriteTimeMeter : NuGenMeterBase
	{
		#region Declarations
		...
		private PerformanceCounter counter = cat.GetCounter(en.PercentDiskWriteTime);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenPercentDiskWriteTimeMeter"/> class.
		/// </summary>
		public NuGenPercentDiskWriteTimeMeter()
		{
			InitializeComponent();
		}
