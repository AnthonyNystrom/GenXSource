/* -----------------------------------------------
 * NuGenAvgDiskBytesPerWriteMeter.cs
...
{
	/// <summary>
	/// Physical Disk -> AvgDiskBytes/Write
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenAvgDiskBytesPerWriteMeter : Genetibase.UI.NuGenMeters.NuGenByteMeterBase
	{
		#region Declarations
		...
		private PerformanceCounter counter = cat.GetCounter(en.AvgDiskBytesPerWrite);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenAvgDiskBytesPerWriteMeter"/> class.
		/// </summary>
		public NuGenAvgDiskBytesPerWriteMeter()
		{
			InitializeComponent();
		}
