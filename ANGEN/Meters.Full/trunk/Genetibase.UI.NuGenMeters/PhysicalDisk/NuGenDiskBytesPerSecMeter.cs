...
{
	/// <summary>
	/// Physical Disk -> DiskBytes/Sec
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenDiskBytesPerSecMeter : Genetibase.UI.NuGenMeters.NuGenByteMeterBase
	{
		#region Declarations
		...
		private PerformanceCounter counter = cat.GetCounter(en.DiskBytesPerSec);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenDiskBytesPerSecMeter"/> class.
		/// </summary>
		public NuGenDiskBytesPerSecMeter()
		{
			InitializeComponent();
		}
