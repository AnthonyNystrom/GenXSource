/* -----------------------------------------------
 * NuGenCurrentDiskQueueLengthMeter.cs
...
namespace Genetibase.UI.NuGenMeters.PhysicalDisk
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenCurrentDiskQueueLengthMeter : NuGenMeterBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenCurrentDiskQueueLengthMeter"/> class.
		/// </summary>
		public NuGenCurrentDiskQueueLengthMeter()
		{
			InitializeComponent();
		}
