/* -----------------------------------------------
 * NuGenPercentDiskReadTimeMeter.cs
...
{
	/// <summary>
	/// Physical Disk -> PercentDiskReadTime
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenPercentDiskReadTimeMeter : NuGenMeterBase
	{
		#region Declarations
		...
		private PerformanceCounter counter = cat.GetCounter(en.PercentDiskReadTime);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenPercentDiskReadTimeMeter"/> class.
		/// </summary>
		public NuGenPercentDiskReadTimeMeter()
		{
			InitializeComponent();
		}
