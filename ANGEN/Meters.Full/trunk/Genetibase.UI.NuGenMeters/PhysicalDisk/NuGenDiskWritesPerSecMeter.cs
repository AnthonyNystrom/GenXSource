...
namespace Genetibase.UI.NuGenMeters.PhysicalDisk
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenDiskWritesPerSecMeter : NuGenMeterBase
	{
		#region Declarations
		...
		private PerformanceCounter counter = cat.GetCounter(en.DiskWritesPerSec);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenDiskWritesPerSecMeter"/> class.
		/// </summary>
		public NuGenDiskWritesPerSecMeter()
		{
			InitializeComponent();
		}
