/* -----------------------------------------------
 * NuGenAvgDiskSecPerWriteMeter.cs
...
{
	/// <summary>
	/// Physical Disk -> AvgDiskSec/Write
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenAvgDiskSecPerWriteMeter : NuGenMeterBase
	{
		#region Declarations
		...
		private PerformanceCounter counter = cat.GetCounter(en.AvgDiskSecPerWrite);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenAvgDiskSecPerWriteMeter"/> class.
		/// </summary>
		public NuGenAvgDiskSecPerWriteMeter()
		{
			InitializeComponent();
		}
