/* -----------------------------------------------
 * NuGenDiskTransfersPerSecMeter.cs
...
{
	/// <summary>
	/// Physical Disk -> DiskTransfers/Sec
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenDiskTransfersPerSecMeter : NuGenMeterBase
	{
		#region Declarations
		...
		private PerformanceCounter counter = cat.GetCounter(en.DiskTransfersPerSec);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenDiskTransfersPerSecMeter"/> class.
		/// </summary>
		public NuGenDiskTransfersPerSecMeter()
		{
			InitializeComponent();
		}
