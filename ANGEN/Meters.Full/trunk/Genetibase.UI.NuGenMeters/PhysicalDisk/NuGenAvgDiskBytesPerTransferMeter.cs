/* -----------------------------------------------
 * NuGenAvgDiskBytesPerTransferMeter.cs
...
{
	/// <summary>
	/// Physical Disk -> AvgDiskBytes/Transfer
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenAvgDiskBytesPerTransferMeter : Genetibase.UI.NuGenMeters.NuGenByteMeterBase
	{
		#region Declarations
		...
		private PerformanceCounter counter = cat.GetCounter(en.AvgDiskBytesPerTransfer);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenAvgDiskBytesPerTransferMeter"/> class.
		/// </summary>
		public NuGenAvgDiskBytesPerTransferMeter()
		{
			InitializeComponent();
		}
