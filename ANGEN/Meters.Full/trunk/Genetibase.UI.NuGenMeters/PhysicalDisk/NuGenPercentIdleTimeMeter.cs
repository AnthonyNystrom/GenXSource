...
{
	/// <summary>
	/// Physical Disk -> PercentIdleTime
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenPercentIdleTimeMeter : NuGenMeterBase
	{
		#region Declarations
		...
		private PerformanceCounter counter = cat.GetCounter(en.PercentIdleTime);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenPercentIdleTimeMeter"/> class.
		/// </summary>
		public NuGenPercentIdleTimeMeter()
		{
			InitializeComponent();
		}
