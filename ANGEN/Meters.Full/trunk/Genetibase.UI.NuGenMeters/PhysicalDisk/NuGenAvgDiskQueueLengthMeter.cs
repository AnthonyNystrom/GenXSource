/* -----------------------------------------------
 * NuGenAvgDiskQueueLengthMeter.cs
...
{
	/// <summary>
	/// Physical Disk -> AvgDiskQueueLength
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenAvgDiskQueueLengthMeter : NuGenMeterBase
	{
		#region Declarations
		...
		private PerformanceCounter counter = cat.GetCounter(en.AvgDiskQueueLength);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenAvgDiskQueueLengthMeter"/> class.
		/// </summary>
		public NuGenAvgDiskQueueLengthMeter()
		{
			InitializeComponent();
		}
