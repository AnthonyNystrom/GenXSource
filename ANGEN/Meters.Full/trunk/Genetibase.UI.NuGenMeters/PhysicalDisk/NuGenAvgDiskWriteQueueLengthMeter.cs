/* -----------------------------------------------
 * NuGenAvgDiskWriteQueueLengthMeter.cs
...
namespace Genetibase.UI.NuGenMeters.PhysicalDisk
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenAvgDiskWriteQueueLengthMeter : NuGenMeterBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenAvgDiskWriteQueueLengthMeter"/> class.
		/// </summary>
		public NuGenAvgDiskWriteQueueLengthMeter()
		{
			InitializeComponent();
		}
