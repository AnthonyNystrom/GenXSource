/* -----------------------------------------------
 * NuGenDiskWriteBytesPerSecMeter.cs
...
{
	/// <summary>
	/// Physical Disk -> DiskWriteBytes/Sec
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenDiskWriteBytesPerSecMeter : Genetibase.UI.NuGenMeters.NuGenByteMeterBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenDiskWriteBytesPerSecMeter"/> class.
		/// </summary>
		public NuGenDiskWriteBytesPerSecMeter()
		{
			InitializeComponent();
		}
