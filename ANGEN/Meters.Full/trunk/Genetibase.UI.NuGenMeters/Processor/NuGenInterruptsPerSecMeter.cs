...
namespace Genetibase.UI.NuGenMeters.Processor
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenInterruptsPerSecMeter : NuGenMeterBase
	{
		#region Declarations
		...
		private PerformanceCounter counter = cat.GetCounter(en.InterruptsPerSec);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenInterruptsPerSecMeter"/> class.
		/// </summary>
		public NuGenInterruptsPerSecMeter()
		{
			InitializeComponent();
		}
