...
namespace Genetibase.UI.NuGenMeters.Processor
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenPercentDpcTimeGraph : NuGenGraphBase
	{
		#region Declarations
		...
		private PerformanceCounter counter = cat.GetCounter(en.PercentDpcTime);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenPercentDpcTimeGraph"/> class.
		/// </summary>
		public NuGenPercentDpcTimeGraph()
		{
			InitializeComponent();
		}
