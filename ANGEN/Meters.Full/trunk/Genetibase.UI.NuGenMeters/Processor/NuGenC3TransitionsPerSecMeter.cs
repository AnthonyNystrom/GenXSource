/* -----------------------------------------------
 * NuGenC3TransitionsPerSecMeter.cs
...
namespace Genetibase.UI.NuGenMeters.Processor
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenC3TransitionsPerSecMeter : NuGenMeterBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenC3TransitionsPerSecMeter"/> class.
		/// </summary>
		public NuGenC3TransitionsPerSecMeter()
		{
			InitializeComponent();
		}
