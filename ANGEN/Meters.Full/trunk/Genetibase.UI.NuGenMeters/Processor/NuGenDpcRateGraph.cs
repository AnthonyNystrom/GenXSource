...
namespace Genetibase.UI.NuGenMeters.Processor
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenDpcRateGraph : NuGenGraphBase
	{
		#region Declarations
		...
		private PerformanceCounter counter = cat.GetCounter(en.DpcRate);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenDpcRateGraph"/> class.
		/// </summary>
		public NuGenDpcRateGraph()
		{
			InitializeComponent();
		}
