...
{
	/// <summary>
	/// Processor -> PercentC3Time
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenPercentC3TimeMeter : NuGenMeterBase
	{
		#region Declarations
		...
		private PerformanceCounter counter = cat.GetCounter(en.PercentC3Time);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenPercentC3TimeMeter"/> class.
		/// </summary>
		public NuGenPercentC3TimeMeter()
		{
			InitializeComponent();
		}
