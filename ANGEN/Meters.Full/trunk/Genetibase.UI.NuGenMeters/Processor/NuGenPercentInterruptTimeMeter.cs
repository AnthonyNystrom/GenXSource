/* -----------------------------------------------
 * NuGenPercentInterruptTimeMeter.cs
...
namespace Genetibase.UI.NuGenMeters.Processor
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenPercentInterruptTimeMeter : NuGenMeterBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenPercentInterruptTimeMeter"/> class.
		/// </summary>
		public NuGenPercentInterruptTimeMeter()
		{
			InitializeComponent();
		}
