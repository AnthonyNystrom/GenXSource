...
namespace Genetibase.UI.NuGenMeters.Processor
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenDpcRateMeter : NuGenMeterBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenDpcRateMeter"/> class.
		/// </summary>
		public NuGenDpcRateMeter()
		{
			InitializeComponent();
		}
