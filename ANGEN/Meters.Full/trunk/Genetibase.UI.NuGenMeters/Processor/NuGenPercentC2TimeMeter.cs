...
{
	/// <summary>
	/// Processor -> PercentC2Time
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenPercentC2TimeMeter : NuGenMeterBase
	{
		#region Declarations
		...
		private PerformanceCounter counter = cat.GetCounter(en.PercentC2Time);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenPercentC2TimeMeter"/> class.
		/// </summary>
		public NuGenPercentC2TimeMeter()
		{
			InitializeComponent();
		}
