...
namespace Genetibase.UI.NuGenMeters.Processor
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenDPCsQueuedPerSecMeter : NuGenMeterBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenDPCsQueuedPerSecMeter"/> class.
		/// </summary>
		public NuGenDPCsQueuedPerSecMeter()
		{
			InitializeComponent();
		}
