/* -----------------------------------------------
 * NuGenC2TransitionsPerSecMeter.cs
...
{
	/// <summary>
	/// Processor -> C2Transitions/sec
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenC2TransitionsPerSecMeter : NuGenMeterBase
	{
		#region Declarations
		...
		private PerformanceCounter counter = cat.GetCounter(en.C2TransitionsPerSec);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenC2TransitionsPerSecMeter"/> class.
		/// </summary>
		public NuGenC2TransitionsPerSecMeter()
		{
			InitializeComponent();
		}
