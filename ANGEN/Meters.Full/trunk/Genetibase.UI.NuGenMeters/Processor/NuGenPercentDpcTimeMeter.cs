...
namespace Genetibase.UI.NuGenMeters.Processor
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenPercentDpcTimeMeter : NuGenMeterBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenPercentDpcTimeMeter"/> class.
		/// </summary>
		public NuGenPercentDpcTimeMeter()
		{
			InitializeComponent();
		}
