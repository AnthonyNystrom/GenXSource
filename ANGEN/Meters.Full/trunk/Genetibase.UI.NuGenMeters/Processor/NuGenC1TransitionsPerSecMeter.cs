/* -----------------------------------------------
 * NuGenC1TransitionsPerSecMeter.cs
...
namespace Genetibase.UI.NuGenMeters.Processor
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenC1TransitionsPerSecMeter : NuGenMeterBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenC1TransitionsPerSecMeter"/> class.
		/// </summary>
		public NuGenC1TransitionsPerSecMeter()
		{
			InitializeComponent();
		}
