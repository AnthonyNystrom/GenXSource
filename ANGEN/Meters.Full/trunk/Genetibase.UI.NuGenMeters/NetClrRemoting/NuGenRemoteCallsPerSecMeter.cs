/* -----------------------------------------------
 * NuGenRemoteCallsPerSecMeter.cs
...
namespace Genetibase.UI.NuGenMeters.NetClrRemoting
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenRemoteCallsPerSecMeter : NuGenMeterBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenRemoteCallsPerSecMeter"/> class.
		/// </summary>
		public NuGenRemoteCallsPerSecMeter()
		{
			InitializeComponent();
		}
