...
namespace Genetibase.UI.NuGenMeters.NetClrRemoting
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenContextsMeter : NuGenMeterBase
	{
		#region Declarations
		...
		private PerformanceCounter counter = cat.GetCounter(en.Contexts);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenContextsMeter"/> class.
		/// </summary>
		public NuGenContextsMeter()
		{
			InitializeComponent();
		}
