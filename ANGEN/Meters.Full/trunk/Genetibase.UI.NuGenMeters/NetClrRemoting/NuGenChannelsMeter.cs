...
namespace Genetibase.UI.NuGenMeters.NetClrRemoting
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenChannelsMeter : NuGenMeterBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenChannelsMeter"/> class.
		/// </summary>
		public NuGenChannelsMeter()
		{
			InitializeComponent();
		}
