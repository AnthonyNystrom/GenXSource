...
namespace Genetibase.UI.NuGenMeters.NetClrRemoting
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenContextsGraph : NuGenGraphBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenContextsGraph"/> class.
		/// </summary>
		public NuGenContextsGraph()
		{
			InitializeComponent();
		}
