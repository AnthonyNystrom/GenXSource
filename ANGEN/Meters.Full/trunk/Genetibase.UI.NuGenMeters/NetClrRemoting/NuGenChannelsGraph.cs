...
namespace Genetibase.UI.NuGenMeters.NetClrRemoting
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenChannelsGraph : NuGenGraphBase
	{
		#region Declarations
		...
		private PerformanceCounter counter = cat.GetCounter(en.Channels);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenChannelsGraph"/> class.
		/// </summary>
		public NuGenChannelsGraph()
		{
			InitializeComponent();
		}
