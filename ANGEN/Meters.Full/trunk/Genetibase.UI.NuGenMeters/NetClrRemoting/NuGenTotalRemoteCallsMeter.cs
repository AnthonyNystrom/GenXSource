...
namespace Genetibase.UI.NuGenMeters.NetClrRemoting
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenTotalRemoteCallsMeter : NuGenMeterBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenTotalRemoteCallsMeter"/> class.
		/// </summary>
		public NuGenTotalRemoteCallsMeter()
		{
			InitializeComponent();
		}
