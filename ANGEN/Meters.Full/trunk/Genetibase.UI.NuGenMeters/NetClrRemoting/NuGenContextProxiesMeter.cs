...
namespace Genetibase.UI.NuGenMeters.NetClrRemoting
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenContextProxiesMeter : NuGenMeterBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenContextProxiesMeter"/> class.
		/// </summary>
		public NuGenContextProxiesMeter()
		{
			InitializeComponent();
		}
