/* -----------------------------------------------
 * NuGenContextBoundObjectsAllocPerSecMeter.cs
...
namespace Genetibase.UI.NuGenMeters.NetClrRemoting
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenContextBoundObjectsAllocPerSecMeter : NuGenMeterBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenContextBoundObjectsAllocPerSecMeter"/> class.
		/// </summary>
		public NuGenContextBoundObjectsAllocPerSecMeter()
		{
			InitializeComponent();
		}
