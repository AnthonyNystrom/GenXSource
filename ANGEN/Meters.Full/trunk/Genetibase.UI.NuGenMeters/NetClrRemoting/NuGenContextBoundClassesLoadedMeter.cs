/* -----------------------------------------------
 * NuGenContextBoundClassesLoadedMeter.cs
...
namespace Genetibase.UI.NuGenMeters.NetClrRemoting
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenContextBoundClassesLoadedMeter : NuGenMeterBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenContextBoundClassesLoadedMeter"/> class.
		/// </summary>
		public NuGenContextBoundClassesLoadedMeter()
		{
			InitializeComponent();
		}
