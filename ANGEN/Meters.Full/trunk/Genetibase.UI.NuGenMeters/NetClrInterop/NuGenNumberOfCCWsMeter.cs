...
namespace Genetibase.UI.NuGenMeters.NetClrInterop
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenNumberOfCCWsMeter : NuGenMeterBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenNumberOfCCWsMeter"/> class.
		/// </summary>
		public NuGenNumberOfCCWsMeter()
		{
			InitializeComponent();
		}
