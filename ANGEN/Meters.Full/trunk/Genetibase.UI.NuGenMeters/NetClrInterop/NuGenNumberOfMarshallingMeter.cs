/* -----------------------------------------------
 * NuGenNumberOfMarshallingMeter.cs
...
namespace Genetibase.UI.NuGenMeters.NetClrInterop
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenNumberOfMarshallingMeter : NuGenMeterBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenNumberOfMarshallingMeter"/> class.
		/// </summary>
		public NuGenNumberOfMarshallingMeter()
		{
			InitializeComponent();
		}
