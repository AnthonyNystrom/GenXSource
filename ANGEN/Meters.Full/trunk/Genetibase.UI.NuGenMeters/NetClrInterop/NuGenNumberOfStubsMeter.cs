...
namespace Genetibase.UI.NuGenMeters.NetClrInterop
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenNumberOfStubsMeter : NuGenMeterBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenNumberOfStubsMeter"/> class.
		/// </summary>
		public NuGenNumberOfStubsMeter()
		{
			InitializeComponent();
		}
