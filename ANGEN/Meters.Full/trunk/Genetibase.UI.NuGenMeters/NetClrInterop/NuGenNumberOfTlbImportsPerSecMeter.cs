/* -----------------------------------------------
 * NuGenNumberOfTlbImportsPerSecMeter.cs
...
namespace Genetibase.UI.NuGenMeters.NetClrInterop
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenNumberOfTlbImportsPerSecMeter : NuGenMeterBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenNumberOfTlbImportsPerSecMeter"/> class.
		/// </summary>
		public NuGenNumberOfTlbImportsPerSecMeter()
		{
			InitializeComponent();
		}
