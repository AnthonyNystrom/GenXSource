/* -----------------------------------------------
 * NuGenLargeObjectHeapSizeGraph.cs
...
namespace Genetibase.UI.NuGenMeters.NetClrMemory
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenLargeObjectHeapSizeGraph : NuGenGraphBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenLargeObjectHeapSizeGraph"/> class.
		/// </summary>
		public NuGenLargeObjectHeapSizeGraph()
		{
			InitializeComponent();
		}
