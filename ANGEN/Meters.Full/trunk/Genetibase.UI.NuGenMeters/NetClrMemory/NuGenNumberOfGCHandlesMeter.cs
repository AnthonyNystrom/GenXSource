/* -----------------------------------------------
 * NuGenNumberOfGCHandlesMeter.cs
...
{
	/// <summary>
	/// .NET CLR Memory -> NumberOfGCHandles
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenNumberOfGCHandlesMeter : NuGenMeterBase
	{
		#region Declarations
		...
		private PerformanceCounter counter = cat.GetCounter(en.NumberOfGCHandles);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenNumberOfGCHandlesMeter"/> class.
		/// </summary>
		public NuGenNumberOfGCHandlesMeter()
		{
			InitializeComponent();
		}
