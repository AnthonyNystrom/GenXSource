/* -----------------------------------------------
 * NuGenNumberOfSinkBlocksInUseMeter.cs
...
namespace Genetibase.UI.NuGenMeters.NetClrMemory
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenNumberOfSinkBlocksInUseMeter : NuGenMeterBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenNumberOfSinkBlocksInUseMeter"/> class.
		/// </summary>
		public NuGenNumberOfSinkBlocksInUseMeter()
		{
			InitializeComponent();
		}
