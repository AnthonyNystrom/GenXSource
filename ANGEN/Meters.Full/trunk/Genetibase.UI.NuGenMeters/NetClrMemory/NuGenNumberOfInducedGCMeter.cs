/* -----------------------------------------------
 * NuGenNumberOfInducedGCMeter.cs
...
{
	/// <summary>
	/// .NET CLR Memory -> NumberOfInducedGC
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenNumberOfInducedGCMeter : NuGenMeterBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenNumberOfInducedGCMeter"/> class.
		/// </summary>
		public NuGenNumberOfInducedGCMeter()
		{
			InitializeComponent();
		}
