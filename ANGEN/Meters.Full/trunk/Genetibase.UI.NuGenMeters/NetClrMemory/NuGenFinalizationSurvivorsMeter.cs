/* -----------------------------------------------
 * NuGenFinalizationSurvivorsMeter.cs
...
{
	/// <summary>
	/// .NET CLR Memory -> FinalizationSurvivors
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenFinalizationSurvivorsMeter : NuGenMeterBase
	{
		#region Declarations
		...
		private PerformanceCounter counter = cat.GetCounter(en.FinalizationSurvivors);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenFinalizationSurvivorsMeter"/> class.
		/// </summary>
		public NuGenFinalizationSurvivorsMeter()
		{
			InitializeComponent();
		}
