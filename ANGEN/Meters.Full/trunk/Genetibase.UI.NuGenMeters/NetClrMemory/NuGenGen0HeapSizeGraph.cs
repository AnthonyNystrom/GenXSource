...
namespace Genetibase.UI.NuGenMeters.NetClrMemory
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenGen0HeapSizeGraph : NuGenGraphBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenGen0HeapSizeGraph"/> class.
		/// </summary>
		public NuGenGen0HeapSizeGraph()
		{
			InitializeComponent();
		}
