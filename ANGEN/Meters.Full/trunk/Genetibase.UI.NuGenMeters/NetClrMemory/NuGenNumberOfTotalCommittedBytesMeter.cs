/* -----------------------------------------------
 * NuGenNumberOfTotalCommittedBytesMeter.cs
...
{
	/// <summary>
	/// .NET CLR Memory -> NumberOfTotalCommittedBytes
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenNumberOfTotalCommittedBytesMeter : Genetibase.UI.NuGenMeters.NuGenByteMeterBase
	{
		#region Declarations
		...
		private PerformanceCounter counter = cat.GetCounter(en.NumberOfTotalCommittedBytes);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenNumberOfTotalCommittedBytesMeter"/> class.
		/// </summary>
		public NuGenNumberOfTotalCommittedBytesMeter()
		{
			InitializeComponent();
		}
