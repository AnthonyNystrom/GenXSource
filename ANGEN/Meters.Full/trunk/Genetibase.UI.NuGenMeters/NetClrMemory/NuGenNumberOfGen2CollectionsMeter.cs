/* -----------------------------------------------
 * NuGenNumberOfGen2CollectionsMeter.cs
...
{
	/// <summary>
	/// .NET CLR Memory -> NumberOfGen2Collections
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenNumberOfGen2CollectionsMeter : NuGenMeterBase
	{
		#region Declarations
		...
		private PerformanceCounter counter = cat.GetCounter(en.NumberOfGen2Collections);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenNumberOfGen2CollectionsMeter"/> class.
		/// </summary>
		public NuGenNumberOfGen2CollectionsMeter()
		{
			InitializeComponent();
		}
