/* -----------------------------------------------
 * NuGenAllocatedBytesPerSecMeter.cs
...
{
	/// <summary>
	/// .NET CLR Memory -> AllocatedBytes/sec
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenAllocatedBytesPerSecMeter : Genetibase.UI.NuGenMeters.NuGenByteMeterBase
	{
		#region Declarations
		...
		private PerformanceCounter counter = cat.GetCounter(en.AllocatedBytesPerSec);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenAllocatedBytesPerSecMeter"/> class.
		/// </summary>
		public NuGenAllocatedBytesPerSecMeter()
		{
			InitializeComponent();
		}
