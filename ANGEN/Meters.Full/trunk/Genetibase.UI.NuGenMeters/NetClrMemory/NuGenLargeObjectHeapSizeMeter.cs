/* -----------------------------------------------
 * NuGenLargeObjectHeapSizeMeter.cs
...
namespace Genetibase.UI.NuGenMeters.NetClrMemory
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenLargeObjectHeapSizeMeter : NuGenMeterBase
	{
		#region Declarations
		...
		private PerformanceCounter counter = cat.GetCounter(en.LargeObjectHeapSize);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenLargeObjectHeapSizeMeter"/> class.
		/// </summary>
		public NuGenLargeObjectHeapSizeMeter()
		{
			InitializeComponent();
		}
