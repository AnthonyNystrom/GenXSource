...
{
	/// <summary>
	/// .NET CLR Memory -> PercentTimeInGC
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenPercentTimeInGCMeter : NuGenMeterBase
	{
		#region Declarations
		...
		private PerformanceCounter counter = cat.GetCounter(en.PercentTimeInGC);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenPercentTimeInGCMeter"/> class.
		/// </summary>
		public NuGenPercentTimeInGCMeter()
		{
			InitializeComponent();
		}
