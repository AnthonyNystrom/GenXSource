/* -----------------------------------------------
 * NuGenNumberOfGen0CollectionsMeter.cs
...
{
	/// <summary>
	/// .NET CLR Memory -> NumberOfGen0Collections
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenNumberOfGen0CollectionsMeter : NuGenMeterBase
	{
		#region Declarations
		...
		private PerformanceCounter counter = cat.GetCounter(en.NumberOfGen0Collections);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenNumberOfGen0CollectionsMeter"/> class.
		/// </summary>
		public NuGenNumberOfGen0CollectionsMeter()
		{
			InitializeComponent();
		}
