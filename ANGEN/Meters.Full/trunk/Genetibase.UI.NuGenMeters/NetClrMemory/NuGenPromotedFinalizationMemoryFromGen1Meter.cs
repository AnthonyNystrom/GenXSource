/* -----------------------------------------------
 * NuGenPromotedFinalizationMemoryFromGen1Meter.cs
...
namespace Genetibase.UI.NuGenMeters.NetClrMemory
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenPromotedFinalizationMemoryFromGen1Meter : NuGenMeterBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenPromotedFinalizationMemoryFromGen1Meter"/> class.
		/// </summary>
		public NuGenPromotedFinalizationMemoryFromGen1Meter()
		{
			InitializeComponent();
		}
