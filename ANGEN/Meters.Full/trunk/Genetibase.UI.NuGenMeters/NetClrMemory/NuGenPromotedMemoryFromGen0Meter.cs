/* -----------------------------------------------
 * NuGenPromotedMemoryFromGen0Meter.cs
...
{
	/// <summary>
	/// .NET CLR Memory -> PromotedMemoryFromGen0
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenPromotedMemoryFromGen0Meter : NuGenMeterBase
	{
		#region Declarations
		...
		private PerformanceCounter counter = cat.GetCounter(en.PromotedMemoryFromGen1);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenPromotedMemoryFromGen0Meter"/> class.
		/// </summary>
		public NuGenPromotedMemoryFromGen0Meter()
		{
			InitializeComponent();
		}
