...
namespace Genetibase.UI.NuGenMeters.NetClrMemory
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenGen2HeapSizeMeter : NuGenMeterBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenGen2HeapSizeMeter"/> class.
		/// </summary>
		public NuGenGen2HeapSizeMeter()
		{
			InitializeComponent();
		}
