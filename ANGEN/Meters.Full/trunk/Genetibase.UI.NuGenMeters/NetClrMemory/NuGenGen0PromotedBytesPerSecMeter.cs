/* -----------------------------------------------
 * NuGenGen0PromotedBytesPerSecMeter.cs
...
{
	/// <summary>
	/// .NET CLR Memory -> Gen0PromotedBytes/sec
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenGen0PromotedBytesPerSecMeter : Genetibase.UI.NuGenMeters.NuGenByteMeterBase
	{
		#region Declarations
		...
		private PerformanceCounter counter = cat.GetCounter(en.Gen0PromotedBytesPerSec);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenGen0PromotedBytesPerSecMeter"/> class.
		/// </summary>
		public NuGenGen0PromotedBytesPerSecMeter()
		{
			InitializeComponent();
		}
