/* -----------------------------------------------
 * NuGenNumberOfPinnedObjectsMeter.cs
...
namespace Genetibase.UI.NuGenMeters.NetClrMemory
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenNumberOfPinnedObjectsMeter : NuGenMeterBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenNumberOfPinnedObjectsMeter"/> class.
		/// </summary>
		public NuGenNumberOfPinnedObjectsMeter()
		{
			InitializeComponent();
		}
