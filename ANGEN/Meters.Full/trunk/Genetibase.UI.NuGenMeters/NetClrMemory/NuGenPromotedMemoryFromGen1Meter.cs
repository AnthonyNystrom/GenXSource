/* -----------------------------------------------
 * NuGenPromotedMemoryFromGen1Meter.cs
...
{
	/// <summary>
	/// .NET CLR Memory -> PromotedMemoryFromGen1
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenPromotedMemoryFromGen1Meter : NuGenMeterBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenPromotedMemoryFromGen1Meter"/> class.
		/// </summary>
		public NuGenPromotedMemoryFromGen1Meter()
		{
			InitializeComponent();
		}
