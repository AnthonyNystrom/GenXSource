/* -----------------------------------------------
 * NuGenNumberOfTotalReservedBytesMeter.cs
...
{
	/// <summary>
	/// .NET CLR Memory -> NumberOfTotalReservedBytess
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenNumberOfTotalReservedBytesMeter : Genetibase.UI.NuGenMeters.NuGenByteMeterBase
	{
		#region Declarations
		...
		private PerformanceCounter counter = cat.GetCounter(en.NumberOfTotalReservedBytes);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenNumberOfTotalReservedBytesMeter"/> class.
		/// </summary>
		public NuGenNumberOfTotalReservedBytesMeter()
		{
			InitializeComponent();
		}
