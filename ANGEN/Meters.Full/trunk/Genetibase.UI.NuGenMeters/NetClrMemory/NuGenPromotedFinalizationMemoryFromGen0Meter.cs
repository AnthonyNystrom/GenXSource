/* -----------------------------------------------
 * NuGenPromotedFinalizationMemoryFromGen0Meter.cs
...
{
	/// <summary>
	/// .NET CLR Memory -> PromotedFinalizationMemoryFromGen0
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenPromotedFinalizationMemoryFromGen0Meter : NuGenMeterBase
	{
		#region Declarations
		...
		private PerformanceCounter counter = cat.GetCounter(en.PromotedFinalizationMemoryFromGen0);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenPromotedFinalizationMemoryFromGen0Meter"/> class.
		/// </summary>
		public NuGenPromotedFinalizationMemoryFromGen0Meter()
		{
			InitializeComponent();
		}
