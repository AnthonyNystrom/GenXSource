/* -----------------------------------------------
 * NuGenNumberOfGen1CollectionsMeter.cs
...
{
	/// <summary>
	/// .NET CLR Memory -> NumberOfGen1Collections
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenNumberOfGen1CollectionsMeter : NuGenMeterBase
	{
		#region Declarations
		...
		private PerformanceCounter counter = cat.GetCounter(en.NumberOfGen1Collections);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenNumberOfGen1CollectionsMeter"/> class.
		/// </summary>
		public NuGenNumberOfGen1CollectionsMeter()
		{
			InitializeComponent();
		}
