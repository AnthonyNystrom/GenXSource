/* -----------------------------------------------
 * NuGenRateOfLoadFailuresMeter.cs
...
namespace Genetibase.UI.NuGenMeters.NetClrLoading
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenRateOfLoadFailuresMeter : NuGenMeterBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenRateOfLoadFailuresMeter"/> class.
		/// </summary>
		public NuGenRateOfLoadFailuresMeter()
		{
			InitializeComponent();
		}
