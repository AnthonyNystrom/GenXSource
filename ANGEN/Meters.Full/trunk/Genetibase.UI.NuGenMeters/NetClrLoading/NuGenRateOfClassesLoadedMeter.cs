/* -----------------------------------------------
 * NuGenRateOfClassesLoadedMeter.cs
...
namespace Genetibase.UI.NuGenMeters.NetClrLoading
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenRateOfClassesLoadedMeter : NuGenMeterBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenRateOfClassesLoadedMeter"/> class.
		/// </summary>
		public NuGenRateOfClassesLoadedMeter()
		{
			InitializeComponent();
		}
