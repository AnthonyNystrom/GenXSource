/* -----------------------------------------------
 * NuGenBytesInLoaderHeapMeter.cs
...
{
	/// <summary>
	/// .NET CLR Loading -> BytesInLoaderHeap
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenBytesInLoaderHeapMeter : Genetibase.UI.NuGenMeters.NuGenByteMeterBase
	{
		#region Declarations
		...
		private PerformanceCounter counter = cat.GetCounter(en.BytesInLoaderHeap);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenBytesInLoaderHeapMeter"/> class.
		/// </summary>
		public NuGenBytesInLoaderHeapMeter()
		{
			InitializeComponent();
		}
