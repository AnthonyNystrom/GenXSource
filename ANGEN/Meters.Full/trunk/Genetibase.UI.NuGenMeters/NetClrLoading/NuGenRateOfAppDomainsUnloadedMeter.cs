/* -----------------------------------------------
 * NuGenRateOfAppDomainsUnloadedMeter.cs
...
{
	/// <summary>
	/// .NET CLR Loading -> RateOfAppDomainsUnloaded
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenRateOfAppDomainsUnloadedMeter : NuGenMeterBase
	{
		#region Declarations
		...
		private PerformanceCounter counter = cat.GetCounter(en.RateOfAppDomainsUnloaded);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenRateOfAppDomainsUnloadedMeter"/> class.
		/// </summary>
		public NuGenRateOfAppDomainsUnloadedMeter()
		{
			InitializeComponent();
		}
