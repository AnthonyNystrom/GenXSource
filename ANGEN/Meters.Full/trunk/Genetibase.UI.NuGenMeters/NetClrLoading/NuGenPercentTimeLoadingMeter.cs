/* -----------------------------------------------
 * NuGenPercentTimeLoadingMeter.cs
...
namespace Genetibase.UI.NuGenMeters.NetClrLoading
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenPercentTimeLoadingMeter : NuGenMeterBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenPercentTimeLoadingMeter"/> class.
		/// </summary>
		public NuGenPercentTimeLoadingMeter()
		{
			InitializeComponent();
		}
