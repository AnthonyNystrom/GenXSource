/* -----------------------------------------------
 * NuGenCurrentClassesLoadedMeter.cs
...
{
	/// <summary>
	/// .NET CLR Loading -> CurrentClassesLoaded
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenCurrentClassesLoadedMeter : NuGenMeterBase
	{
		#region Declarations
		...
		private PerformanceCounter counter = cat.GetCounter(en.CurrentClassesLoaded);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenCurrentClassesLoadedMeter"/> class.
		/// </summary>
		public NuGenCurrentClassesLoadedMeter()
		{
			InitializeComponent();
		}
