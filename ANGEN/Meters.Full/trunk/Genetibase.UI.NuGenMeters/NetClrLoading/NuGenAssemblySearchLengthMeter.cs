/* -----------------------------------------------
 * NuGenAssemblySearchLengthMeter.cs
...
namespace Genetibase.UI.NuGenMeters.NetClrLoading
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenAssemblySearchLengthMeter : NuGenMeterBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenAssemblySearchLengthMeter"/> class.
		/// </summary>
		public NuGenAssemblySearchLengthMeter()
		{
			InitializeComponent();
		}
