/* -----------------------------------------------
 * NuGenCurrentAssembliesMeter.cs
...
{
	/// <summary>
	/// .NET CLR Loading -> CurrentAssemblies
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenCurrentAssembliesMeter : NuGenMeterBase
	{
		#region Declarations
		...
		private PerformanceCounter counter = cat.GetCounter(en.CurrentAssemblies);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenCurrentAssembliesMeter"/> class.
		/// </summary>
		public NuGenCurrentAssembliesMeter()
		{
			InitializeComponent();
		}
