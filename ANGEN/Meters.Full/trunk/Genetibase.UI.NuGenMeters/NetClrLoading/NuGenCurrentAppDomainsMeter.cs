/* -----------------------------------------------
 * NuGenCurrentAppDomainsMeter.cs
...
{
	/// <summary>
	/// .NET CLR Loading -> CurrentAppDomains
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenCurrentAppDomainsMeter : NuGenMeterBase
	{
		#region Declarations
		...
		private PerformanceCounter counter = cat.GetCounter(en.CurrentAppDomains);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenCurrentAppDomainsMeter"/> class.
		/// </summary>
		public NuGenCurrentAppDomainsMeter()
		{
			InitializeComponent();
		}
