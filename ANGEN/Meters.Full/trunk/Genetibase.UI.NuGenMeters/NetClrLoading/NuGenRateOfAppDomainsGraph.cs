...
namespace Genetibase.UI.NuGenMeters.NetClrLoading
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenRateOfAppDomainsGraph : NuGenGraphBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenRateOfAppDomainsGraph"/> class.
		/// </summary>
		public NuGenRateOfAppDomainsGraph()
		{
			InitializeComponent();
		}
