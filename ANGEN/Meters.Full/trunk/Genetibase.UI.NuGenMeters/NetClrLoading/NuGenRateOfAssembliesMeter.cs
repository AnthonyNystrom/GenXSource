...
{
	/// <summary>
	/// .NET CLR Loading -> RateOfAssemblies
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenRateOfAssembliesMeter : NuGenMeterBase
	{
		#region Declarations
		...
		private PerformanceCounter counter = cat.GetCounter(en.RateOfAssemblies);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenRateOfAssembliesMeter"/> class.
		/// </summary>
		public NuGenRateOfAssembliesMeter()
		{
			InitializeComponent();
		}
