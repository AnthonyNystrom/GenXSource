/* -----------------------------------------------
 * NuGenTotalNumberOfLoadFailuresMeter.cs
...
namespace Genetibase.UI.NuGenMeters.NetClrLoading
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenTotalNumberOfLoadFailuresMeter : NuGenMeterBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenTotalNumberOfLoadFailuresMeter"/> class.
		/// </summary>
		public NuGenTotalNumberOfLoadFailuresMeter()
		{
			InitializeComponent();
		}
