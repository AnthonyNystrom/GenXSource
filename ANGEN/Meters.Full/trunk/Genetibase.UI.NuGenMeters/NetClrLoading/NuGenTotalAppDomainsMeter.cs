...
namespace Genetibase.UI.NuGenMeters.NetClrLoading
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenTotalAppDomainsMeter : NuGenMeterBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenTotalAppDomainsMeter"/> class.
		/// </summary>
		public NuGenTotalAppDomainsMeter()
		{
			InitializeComponent();
		}
