/* -----------------------------------------------
 * NuGenTotalClassesLoadedGraph.cs
...
namespace Genetibase.UI.NuGenMeters.NetClrLoading
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenTotalClassesLoadedGraph : NuGenGraphBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenTotalClassesLoadedGraph"/> class.
		/// </summary>
		public NuGenTotalClassesLoadedGraph()
		{
			InitializeComponent();
		}
