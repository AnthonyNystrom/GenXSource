...
namespace Genetibase.UI.NuGenMeters.Thread
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenThreadStateMeter : NuGenMeterBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenThreadStateMeter"/> class.
		/// </summary>
		public NuGenThreadStateMeter()
		{
			InitializeComponent();
		}
