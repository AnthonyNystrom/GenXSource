...
namespace Genetibase.UI.NuGenMeters.Thread
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenThreadWaitReasonMeter : NuGenMeterBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenThreadWaitReasonMeter"/> class.
		/// </summary>
		public NuGenThreadWaitReasonMeter()
		{
			InitializeComponent();
		}
