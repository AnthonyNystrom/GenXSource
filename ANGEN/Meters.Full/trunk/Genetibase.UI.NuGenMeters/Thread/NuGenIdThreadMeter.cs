...
namespace Genetibase.UI.NuGenMeters.Thread
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenIdThreadMeter : NuGenMeterBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenIdThreadMeter"/> class.
		/// </summary>
		public NuGenIdThreadMeter()
		{
			InitializeComponent();
		}
