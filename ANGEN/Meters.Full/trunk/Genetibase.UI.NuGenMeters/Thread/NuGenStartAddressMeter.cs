...
namespace Genetibase.UI.NuGenMeters.Thread
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenStartAddressMeter : NuGenMeterBase
	{
		#region Declarations
		...
		private PerformanceCounter counter = cat.GetCounter(en.StartAddress);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenStartAddressMeter"/> class.
		/// </summary>
		public NuGenStartAddressMeter()
		{
			InitializeComponent();
		}
