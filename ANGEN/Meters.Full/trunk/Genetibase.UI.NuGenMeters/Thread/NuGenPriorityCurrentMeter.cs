...
namespace Genetibase.UI.NuGenMeters.Thread
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenPriorityCurrentMeter : NuGenMeterBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenPriorityCurrentMeter"/> class.
		/// </summary>
		public NuGenPriorityCurrentMeter()
		{
			InitializeComponent();
		}
