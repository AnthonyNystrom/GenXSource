...
namespace Genetibase.UI.NuGenMeters.Thread
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenIdThreadGraph : NuGenGraphBase
	{
		#region Declarations
		...
		private PerformanceCounter counter = cat.GetCounter(en.IdThread);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenIdThreadGraph"/> class.
		/// </summary>
		public NuGenIdThreadGraph()
		{
			InitializeComponent();
		}
