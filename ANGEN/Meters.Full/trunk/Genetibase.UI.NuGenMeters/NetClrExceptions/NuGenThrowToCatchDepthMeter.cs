/* -----------------------------------------------
 * NuGenThrowToCatchDepthMeter.cs
...
{
	/// <summary>
	/// .NET CLR Exceptions -> ThrowToCatchDepth
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenThrowToCatchDepthMeter : NuGenMeterBase
	{
		#region Declarations
		...
		private PerformanceCounter counter = cat.GetCounter(en.ThrowToCatchDepth);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenThrowToCatchDepthMeter"/> class.
		/// </summary>
		public NuGenThrowToCatchDepthMeter()
		{
			InitializeComponent();
		}
