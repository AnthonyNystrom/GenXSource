/* -----------------------------------------------
 * NuGenNumberOfFinallysPerSecMeter.cs
...
namespace Genetibase.UI.NuGenMeters.NetClrExceptions
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenNumberOfFinallysPerSecMeter : NuGenMeterBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenNumberOfFinallysPerSecMeter"/> class.
		/// </summary>
		public NuGenNumberOfFinallysPerSecMeter()
		{
			InitializeComponent();
		}
