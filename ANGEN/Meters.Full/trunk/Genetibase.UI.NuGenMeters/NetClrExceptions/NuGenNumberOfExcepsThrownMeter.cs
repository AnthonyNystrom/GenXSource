/* -----------------------------------------------
 * NuGenNumberOfExcepsThrownMeter.cs
...
using Genetibase.PerformanceCounters;
...
{
	/// <summary>
	/// .NET CLR Exceptions -> NumberOfExcepsThrown
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenNumberOfExcepsThrownMeter : NuGenMeterBase
	{
		#region Declarations
		
		private IContainer components = null;
		private PerformanceCounter counter = cat.GetCounter(en.NumberOfExcepsThrown);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenNumberOfExcepsThrownMeter"/> class.
		/// </summary>
		public NuGenNumberOfExcepsThrownMeter()
		{
			InitializeComponent();
		}
