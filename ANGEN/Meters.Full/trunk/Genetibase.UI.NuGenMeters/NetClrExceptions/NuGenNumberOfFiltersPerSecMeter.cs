/* -----------------------------------------------
 * NuGenNumberOfFiltersPerSecMeter.cs
...
{
	/// <summary>
	/// .NET CLR Exceptions -> NumberOfFilters/sec
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenNumberOfFiltersPerSecMeter : NuGenMeterBase
	{
		#region Declarations
		...
		private PerformanceCounter counter = cat.GetCounter(en.NumberOfFiltersPerSec);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenNumberOfFiltersPerSecMeter"/> class.
		/// </summary>
		public NuGenNumberOfFiltersPerSecMeter()
		{
			InitializeComponent();
		}
