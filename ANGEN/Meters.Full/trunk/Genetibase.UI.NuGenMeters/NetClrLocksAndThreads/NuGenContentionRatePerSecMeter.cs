/* -----------------------------------------------
 * NuGenContentionRatePerSecMeter.cs
...
{
	/// <summary>
	/// .NET CLR Locks And Threads -> ContentionRate/sec
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenContentionRatePerSecMeter : NuGenMeterBase
	{
		#region Declarations
		...
		private PerformanceCounter counter = cat.GetCounter(en.ContentionRatePerSec);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenContentionRatePerSecMeter"/> class.
		/// </summary>
		public NuGenContentionRatePerSecMeter()
		{
			InitializeComponent();
		}
