/* -----------------------------------------------
 * NuGenCurrentQueueLengthMeter.cs
...
namespace Genetibase.UI.NuGenMeters.NetClrLocksAndThreads
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenCurrentQueueLengthMeter : NuGenMeterBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenCurrentQueueLengthMeter"/> class.
		/// </summary>
		public NuGenCurrentQueueLengthMeter()
		{
			InitializeComponent();
		}
