/* -----------------------------------------------
 * NuGenTotalNumberOfContentionsMeter.cs
...
namespace Genetibase.UI.NuGenMeters.NetClrLocksAndThreads
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenTotalNumberOfContentionsMeter : NuGenMeterBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenTotalNumberOfContentionsMeter"/> class.
		/// </summary>
		public NuGenTotalNumberOfContentionsMeter()
		{
			InitializeComponent();
		}
