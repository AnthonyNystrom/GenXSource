...
namespace Genetibase.UI.NuGenMeters.NetClrLocksAndThreads
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenQueueLengthPeakMeter : NuGenMeterBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenQueueLengthPeakMeter"/> class.
		/// </summary>
		public NuGenQueueLengthPeakMeter()
		{
			InitializeComponent();
		}
