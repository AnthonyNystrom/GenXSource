/* -----------------------------------------------
 * NuGenNumberOfCurrentRecognizedThreadsMeter.cs
...
{
	/// <summary>
	/// .NET CLR Locks And Threads -> NumberOfCurrentRecognizedThreads
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenNumberOfCurrentRecognizedThreadsMeter : NuGenMeterBase
	{
		#region Declarations
		...
		private PerformanceCounter counter = cat.GetCounter(en.NumberOfCurrentRecognizedThreads);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenNumberOfCurrentRecognizedThreadsMeter"/> class.
		/// </summary>
		public NuGenNumberOfCurrentRecognizedThreadsMeter()
		{
			InitializeComponent();
		}
