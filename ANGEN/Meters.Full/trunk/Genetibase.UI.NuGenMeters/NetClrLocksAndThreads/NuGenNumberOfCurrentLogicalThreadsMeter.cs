/* -----------------------------------------------
 * NuGenNumberOfCurrentLogicalThreadsMeter.cs
...
namespace Genetibase.UI.NuGenMeters.NetClrLocksAndThreads
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenNumberOfCurrentLogicalThreadsMeter : NuGenMeterBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenNumberOfCurrentLogicalThreadsMeter"/> class.
		/// </summary>
		public NuGenNumberOfCurrentLogicalThreadsMeter()
		{
			InitializeComponent();
		}
