/* -----------------------------------------------
 * NuGenRateOfRecognizedThreadsPerSecMeter.cs
...
{
	/// <summary>
	/// .NET CLR Locks And Threads -> RateOfRecognizedThreads/sec
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenRateOfRecognizedThreadsPerSecMeter : NuGenMeterBase
	{
		#region Declarations
		...
		private PerformanceCounter counter = cat.GetCounter(en.RateOfRecognizedThreadsPerSec);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenRateOfRecognizedThreadsPerSecMeter"/> class.
		/// </summary>
		public NuGenRateOfRecognizedThreadsPerSecMeter()
		{
			InitializeComponent();
		}
