/* -----------------------------------------------
 * NuGenNumberOfCurrentPhysicalThreadsMeter.cs
...
{
	/// <summary>
	/// .NET CLR Locks And Threads -> NumberOfCurrentPhysicalThreads
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenNumberOfCurrentPhysicalThreadsMeter : NuGenMeterBase
	{
		#region Declarations
		...
		private PerformanceCounter counter = cat.GetCounter(en.NumberOfCurrentPhysicalThreads);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenNumberOfCurrentPhysicalThreadsMeter"/> class.
		/// </summary>
		public NuGenNumberOfCurrentPhysicalThreadsMeter()
		{
			InitializeComponent();
		}
