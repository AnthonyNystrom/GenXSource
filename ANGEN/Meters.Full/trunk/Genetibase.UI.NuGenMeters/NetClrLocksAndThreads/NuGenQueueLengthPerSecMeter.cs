/* -----------------------------------------------
 * NuGenQueueLengthPerSecMeter.cs
...
{
	/// <summary>
	/// .NET CLR Locks And Threads -> QueueLnegth/sec
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenQueueLengthPerSecMeter : NuGenMeterBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenQueueLengthPerSecMeter"/> class.
		/// </summary>
		public NuGenQueueLengthPerSecMeter()
		{
			InitializeComponent();
		}
