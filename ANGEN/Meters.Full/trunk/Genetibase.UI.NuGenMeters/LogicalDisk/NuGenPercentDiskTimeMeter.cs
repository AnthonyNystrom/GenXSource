...
{
	/// <summary>
	/// Logical Disk -> PercentDiskTime
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenPercentDiskTimeMeter : NuGenMeterBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenPercentDiskTimeMeter"/> class.
		/// </summary>
		public NuGenPercentDiskTimeMeter()
		{
			InitializeComponent();
		}
