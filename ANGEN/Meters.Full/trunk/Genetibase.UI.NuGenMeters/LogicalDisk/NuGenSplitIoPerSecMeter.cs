...
{
	/// <summary>
	/// Logical Disk -> SplitIO/sec
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenSplitIoPerSecMeter : NuGenMeterBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenSplitIoPerSecMeter"/> class.
		/// </summary>
		public NuGenSplitIoPerSecMeter()
		{
			InitializeComponent();
		}
