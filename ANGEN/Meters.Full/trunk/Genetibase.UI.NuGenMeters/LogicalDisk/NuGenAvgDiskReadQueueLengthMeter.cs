/* -----------------------------------------------
 * NuGenAvgDiskReadQueueLengthMeter.cs
...
namespace Genetibase.UI.NuGenMeters.LogicalDisk
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenAvgDiskReadQueueLengthMeter : NuGenMeterBase
	{
		#region Declarations
		...
		private PerformanceCounter counter = cat.GetCounter(en.AvgDiskReadQueueLength);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenAvgDiskReadQueueLengthMeter"/> class.
		/// </summary>
		public NuGenAvgDiskReadQueueLengthMeter()
		{
			InitializeComponent();
		}
