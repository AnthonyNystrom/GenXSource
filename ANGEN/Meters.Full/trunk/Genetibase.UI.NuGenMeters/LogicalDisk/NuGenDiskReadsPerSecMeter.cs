...
namespace Genetibase.UI.NuGenMeters.LogicalDisk
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenDiskReadsPerSecMeter : NuGenMeterBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenDiskReadsPerSecMeter"/> class.
		/// </summary>
		public NuGenDiskReadsPerSecMeter()
		{
			InitializeComponent();
		}
