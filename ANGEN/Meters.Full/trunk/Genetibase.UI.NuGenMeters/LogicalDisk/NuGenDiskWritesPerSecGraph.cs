...
namespace Genetibase.UI.NuGenMeters.LogicalDisk
{
	...
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenDiskWritesPerSecGraph : NuGenGraphBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenDiskWritesPerSecGraph"/> class.
		/// </summary>
		public NuGenDiskWritesPerSecGraph()
		{
			InitializeComponent();
		}
