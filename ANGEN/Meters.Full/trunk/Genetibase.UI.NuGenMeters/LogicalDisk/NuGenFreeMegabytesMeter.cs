...
{
	/// <summary>
	/// Logical Disk -> FreeMegabyts
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenFreeMegabytesMeter : NuGenMeterBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenFreeMegabytesMeter"/> class.
		/// </summary>
		public NuGenFreeMegabytesMeter()
		{
			InitializeComponent();
		}
