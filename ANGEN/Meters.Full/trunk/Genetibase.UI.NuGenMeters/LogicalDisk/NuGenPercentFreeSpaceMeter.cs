...
{
	/// <summary>
	/// Logical Disk -> PercentFreeSpace
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenPercentFreeSpaceMeter : NuGenMeterBase
	{
		#region Declarations
		...
		private PerformanceCounter counter = cat.GetCounter(en.PercentFreeSpace);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenPercentFreeSpaceMeter"/> class.
		/// </summary>
		public NuGenPercentFreeSpaceMeter()
		{
			InitializeComponent();
		}
