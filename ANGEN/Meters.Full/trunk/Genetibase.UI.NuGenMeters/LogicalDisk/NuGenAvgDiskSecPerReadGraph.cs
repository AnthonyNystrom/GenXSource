/* -----------------------------------------------
 * NuGenAvgDiskSecPerReadGraph.cs
...
{
	/// <summary>
	/// Logical Disk -> AvgDiskSec/Read
	/// </summary>
	[ToolboxItem(true)]
	public class NuGenAvgDiskSecPerReadGraph : NuGenGraphBase
	{
		#region Declarations
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NuGenAvgDiskSecPerReadGraph"/> class.
		/// </summary>
		public NuGenAvgDiskSecPerReadGraph()
		{
			InitializeComponent();
		}
