...
namespace Genetibase.Shared.Design
{
	...
	public sealed class NuGenTransparencyConverter : TypeConverter
	{
		...
		public override object ConvertFrom(ITypeDescriptorContext context, System.Globalization.CultureInfo culture, object value)
		{
			...
			if (strValue != null)
			{
				string bufferValue = strValue.Trim();
				...
				try 
				{
					bufferTransparency = int.Parse(bufferValue, NumberStyles.Integer, CultureInfo.InvariantCulture);
				}
				catch (FormatException)
				{
					Trace.WriteLine("The specified value was not in the correct format.\nvalue = " + value.ToString(), "Error");
					MessageBox.Show(
						Resources.Message_TransparencyConverter_FormatException
						, Resources.Caption_Alert
