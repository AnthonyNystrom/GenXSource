...
namespace Genetibase.Shared.Service
{
	...
	/// </summary>
	public sealed class NuGenFusion
	{
		/*
		...
		/// <summary>
		/// Gets a pointer to a new <see cref="T:IAssemblyCache"/> instance representing the Global Assembly Cache.
		/// </summary>
		/// <param name="ppAsmCache">The returned <see cref="T:IAssemblyCache"/> pointer.</param>
		...
		/// <summary>
		/// Gets a pointer to an <see cref="T:IAssemblyEnum"/> for the assembly with the specified
		/// <see cref="T:IAssemblyName"/>.
		/// </summary>
		/// <param name="ppEnum">The requested <see cref="T:IAssemblyEnum"/> pointer.</param>
		/// <param name="pAppCtx">No documentation available.</param>
		/// <param name="pName">The <see cref="T:IAssemblyName"/> of the requested assembly.</param>
		...
		/// <summary>
		/// Gets an interface pointer to an <see cref="T:IAssemblyName"/>
		/// instance that represents the unique identity of the assembly with the specified name.
		/// </summary>
		/// <param name="ppName">The returned <see cref="T:IAssemblyName"/>.</param>
		/// <param name="szAssemblyName">The name of the assembly for which to create the new <see cref="T:IAssemblyName"/> instance.</param>
		...
		/// containing *.ini files that can be read with <see cref="T:IHistoryReader"/>.
		/// </summary>
		/// <param name="wzDir">The returned pointer to the path.</param>
