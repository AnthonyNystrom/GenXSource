...
#Region " Fields "
    ...
    'Private _projecttext As String
#End Region
...
#End Region
    ...
    '        dialog.Filter() = TITLE + " files (*.nvd|*.nvd|All files (*.*)|*.*"
    ...
    '        dialog.DefaultExt = "nvd"
    '        If (fFilePath.ToString = "") Or (fFilePath.Length = 0) Then
    '            dialog.FileName = fFileName
    '        Else
    '            dialog.FileName = fFilePath
    '        End If
    '        dialog.Filter() = TITLE + "file (*.nvd)|*.nvd|Ink Serialized Format (*.isf)|*.isf|Mhtml (*.mht)|*.mht|Image (*.png)|*.png|Rich text (*.rtf)|*.rtf|Plain text (*.txt)|*.txt"
    '        If dialog.ShowDialog() = DialogResult.OK Then
...
#End Region
    ...
    Private Sub UiButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles UiButton1.Click
        ...
        If Not frmCt.DialogResult = Windows.Forms.DialogResult.Cancel Then
            ...
            If Not Me.UiCheckBox2.Checked Then
                frmCap.nuGenScreenCap1.ShowMouseCoordinates = False
            End If
    ...
    Private Sub ExplorerBar3_ItemClick(ByVal sender As Object, ByVal e As Janus.Windows.ExplorerBar.ItemEventArgs) Handles ExplorerBar3.ItemClick
    ...
    Private Sub ScribbleBox1_MouseLeave(ByVal sender As Object, ByVal e As System.EventArgs) Handles ScribbleBox1.MouseLeave
        DSTBLPROJECTS.Update()
        GridEX1.CollapseCards()
    End Sub

    Private Sub TSTBLPROJECTS_AfterChanges(ByVal sender As Object, ByVal e As C1.Data.RowChangeEventArgs) Handles TSTBLPROJECTS.AfterChanges
        Me.Text = "Project " & TSTBLPROJECTS.CurrentRow.Item("strProjectIdentity") & " - " & TITLE
    End Sub

    Private Sub TSTBLPROJECTS_PositionChanged(ByVal sender As Object, ByVal e As C1.Data.PositionChangeEventArgs) Handles TSTBLPROJECTS.PositionChanged
        Me.Text = "Project " & TSTBLPROJECTS.CurrentRow.Item("strProjectIdentity") & " - " & TITLE
    End Sub
