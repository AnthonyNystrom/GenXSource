...
#Region " Load/Save user settings "
    ...
    Private Sub Form11024_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Me.ScribbleBox1.Dispose()
    End Sub
...
#End Region
    ...
    Private Sub CAPTUREToolStripMenuItem1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        'Hide()
        'CType(Me.Parent, Form_Firms).Hide()
