...
Public Class NuGenScribblePreviewer
    ...
    Public Overrides Sub DoPreview(ByVal scribble As Agilix.Ink.Scribble.Scribble)
        ...
        PreviewControl.StartPage = scribble.Document.Pages.IndexOf(scribble.Page)
    End Sub
    ...
    Public Overrides Sub DoPreviewDialog(ByVal Scribble As Agilix.Ink.Scribble.Scribble)
        ...
        With PreviewDialog
            .Document = Document
            .PrintPreviewControl.StartPage = Scribble.Document.Pages.IndexOf(Scribble.Page)
            .ShowDialog()
        End With
    End Sub
End Class
