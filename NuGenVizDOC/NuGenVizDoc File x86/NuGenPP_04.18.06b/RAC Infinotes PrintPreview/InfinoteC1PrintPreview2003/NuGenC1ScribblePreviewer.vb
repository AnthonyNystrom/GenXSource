...
Public Class NuGenC1ScribblePreviewer
    ...
    Public Overrides Sub DoPreview(ByVal scribble As Agilix.Ink.Scribble.Scribble)
        ...
        ' Page count in C1PrintPreviewControl is 1-based
        PreviewControl.StartPage = scribble.Document.Pages.IndexOf(scribble.Page) + 1
    End Sub
    ...
    Public Overrides Sub DoPreviewDialog(ByVal Scribble As Agilix.Ink.Scribble.Scribble)
        ...
        With PreviewDialog
            .Document = Document
            ' Page count in C1PrintPreviewControl is 1-based
            .C1PrintPreviewControl.StartPage = Scribble.Document.Pages.IndexOf(Scribble.Page) + 1
            .ShowDialog()
        End With
    End Sub
