...
#region Genetibase.Win32Imports

namespace Genetibase.Private.Win32Imports
{
...
namespace Genetibase.UI
{
	...
	using Genetibase.Private.Win32Imports;
	...
	/// </summary>
	public class NuGenUISnap : System.Windows.Forms.NativeWindow
	{
		/// <summary>
		/// Global List of registered NuGenUISnaps
		/// </summary>
		private static ArrayList	GlobalNuGenUISnaps = new ArrayList();
		...
		{
			GlobalNuGenUISnaps.Add ( frmExternal );
		}
		/// <summary>
		...
		{
			GlobalNuGenUISnaps.Remove ( frmExternal );
		}

		#endregion

		#region NuGenUISnap Constructor
		/// <summary>
		...
		protected override void OnHandleChange()
		{
			...
			{
				GlobalNuGenUISnaps.Add ( this.originalForm );
			} 
			else
			{
				GlobalNuGenUISnaps.Remove ( this.originalForm );
			}
		}
		#endregion
		...
		private void Resize( Point p )
		{
			...
			if ( stickToOther )
			{
				...
				foreach ( Form sw in GlobalNuGenUISnaps )
				{
