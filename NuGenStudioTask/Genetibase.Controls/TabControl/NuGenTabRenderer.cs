...
namespace Genetibase.Controls
{
	/// <summary>
	/// </summary>
	public class NuGenTabRenderer : INuGenTabRenderer
	{
		...
		public void DrawTabBody(NuGenTabBodyPaintParams paintParams)
		{
			if (paintParams == null)
			{
				throw new ArgumentNullException("tabPageParams");
			}
		...
		/// <returns></returns>
		public virtual Padding GetPadding(FlatStyle flatStyle)
		{
			switch (flatStyle)
			{
				case FlatStyle.Flat:
		...
		/// <summary>
		/// </summary>
		protected VisualStyleRenderer TabBodyVisualStyleRenderer
		{
			get
			{
		...
		/// </para>
		/// </exception>
		protected virtual void DrawTabBodyFlat(Graphics g, Rectangle bounds)
		{
			if (g == null)
			{
		...
		/// </para>
		/// </exception>
		protected virtual void DrawTabBodyNotched(Graphics g, Rectangle bounds)
		{
			if (g == null)
			{
				throw new ArgumentNullException("g");
		...
		/// </para>
		/// </exception>
		protected virtual void DrawTabBodyFlatUsingVisualStyles(Graphics g, Rectangle bounds)
		{
			if (g == null)
			{
				throw new ArgumentNullException("g");
		...
		/// </para>
		/// </exception>
		protected virtual void DrawTabButtonBackground(Graphics g, Rectangle bounds, TabItemState state)
		{
			if (g == null)
			{
				throw new ArgumentNullException("g");
		...
		/// </para>
		/// </exception>
		protected virtual void DrawTabButtonImage(
			Graphics g,
			Image imageToDraw,
			...
			)
		{
			...
			if (enabled)
			{
				g.DrawImageUnscaled(imageToDraw, imageBounds);
			}
			else
			{
				ControlPaint.DrawImageDisabled(g, imageToDraw, imageBounds.X, imageBounds.Y, SystemColors.Control);
			}
		}
		...
		/// </para>
		/// </exception>
		protected virtual void DrawTabButtonText(
			Graphics g,
			string text,
		...
		/// </para>
		/// </exception>
		protected virtual void DrawTabPageBackground(Graphics g, Rectangle bounds)
		{
			if (g == null)
			{
				throw new ArgumentNullException("g");
		...
		///		Visual styles are not currently available.
		/// </exception>
		protected virtual void DrawTabPageBackgroundUsingVisualStyles(Graphics g, Rectangle bounds)
		{
			if (g == null)
			{
				throw new ArgumentNullException("g");
