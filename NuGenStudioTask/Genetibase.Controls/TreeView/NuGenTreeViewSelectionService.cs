...
namespace Genetibase.Controls
{
	...
	/// </summary>
	public class NuGenTreeViewSelectionService : INuGenTreeViewSelectionService
	{
		...
		private List<NuGenTreeNode> selectedNodes = null;
		...
		public List<NuGenTreeNode> SelectedNodes
		{
			get
			{
				...
				{
					this.selectedNodes = new List<NuGenTreeNode>();
				}
