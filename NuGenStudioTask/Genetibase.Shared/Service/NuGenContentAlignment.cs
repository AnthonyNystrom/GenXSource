...
namespace Genetibase.Shared.Service
{
	...
	public sealed class NuGenContentAlignment
	{
		...
		/// <summary>
		/// Gets the <see cref="T:StringAlignment"/> from the specified <see cref="T:ContentAlignment"/>.
		/// </summary>
		/// <param name="contentAlignment">The <see cref="T:ContentAlignment"/>.</param>
		/// <returns></returns>
		public static StringAlignment GetAlignment(ContentAlignment contentAlignment)
		{
			if ((contentAlignment & ContentAlignment.BottomCenter) != 0
				|| (contentAlignment & ContentAlignment.MiddleCenter) != 0
				|| (contentAlignment & ContentAlignment.TopCenter) != 0)
			{
				return StringAlignment.Center;
			}
			else if ((contentAlignment & ContentAlignment.BottomRight) != 0
		...
		/// <summary>
		/// Gets the line <see cref="T:StringAlignment"/> from the specified <see cref="T:ContentAlignment"/>.
		/// </summary>
		/// <param name="contentAlignment">The <see cref="T:ContentAlignment"/>.</param>
		/// <returns></returns>
		public static StringAlignment GetLineAlignment(ContentAlignment contentAlignment)
		{
			if ((contentAlignment & ContentAlignment.MiddleCenter) != 0
				|| (contentAlignment & ContentAlignment.MiddleLeft) != 0
				|| (contentAlignment & ContentAlignment.MiddleRight) != 0)
			{
				return StringAlignment.Center;
			}
			else if ((contentAlignment & ContentAlignment.BottomCenter) != 0
