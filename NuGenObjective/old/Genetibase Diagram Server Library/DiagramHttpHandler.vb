...
Public Class DiagramHttpHandler
    ...
    Private Const originalFileName As String = "original.diagram"
    Private Const currentFileName As String = "current.diagram"
    Private Const lockFileName As String = "lock.diagramlock"
...
#Region " Utility methods "
    ...
    Private Function CreateLock(ByVal filePath As String) As Hashtable
        Dim result As New Hashtable
        Dim lockPath As String = Path.Combine(filePath, "lock.diagramlock")
