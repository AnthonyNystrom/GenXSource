...
Partial Class ShowDiagram
    ...
    Private Function CreatePathToDiagram(ByVal rootPath As String, ByVal fileName As String) As String
        ...
        If result.EndsWith(".diagram", StringComparison.InvariantCultureIgnoreCase) Then
            result = result.Remove(result.LastIndexOf(".diagram", StringComparison.InvariantCultureIgnoreCase))
        End If
        result = IO.Path.Combine(result, "current.diagram")
        Return result
    End Function
    ...
    Protected Overrides Sub CreateChildControls()
        ...
        If fileName <> "" Then
            Try
                ...
                If Not imageURL.EndsWith(".diagram", StringComparison.InvariantCultureIgnoreCase) Then
                    imageURL &= ".diagram"
                End If
                If pageName <> "" Then
