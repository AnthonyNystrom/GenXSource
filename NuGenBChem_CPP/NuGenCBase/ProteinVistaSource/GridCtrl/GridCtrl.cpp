...
CGridCtrl::CGridCtrl(int nRows, int nCols, int nFixedRows, int nFixedCols)
{
    ...
    m_nTimerInterval      = 100/2;         // (in milliseconds)
...
void CGridCtrl::OnHScroll(UINT nSBCode, UINT /*nPos*/, CScrollBar* /*pScrollBar*/)
{
	...
	SendMessageToParent(0,0, LVN_ENDSCROLL);
}
...
void CGridCtrl::SetBackColorSettingEanble()
{
	m_BackColorSettingEnble = TRUE;
}
void CGridCtrl::SetBackColorSettingDisable()
{
	m_BackColorSettingEnble = FALSE;
}
