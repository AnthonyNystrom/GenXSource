...
CHTMLListCtrl::CHTMLListCtrl()
{
	...
	m_clrBkCtrlItem = GetSysColor(COLOR_WINDOW);
	m_clrTextCtrlItem = GetSysColor(COLOR_WINDOWTEXT);

	m_clrBkSelectedItem = GetSysColor(COLOR_HIGHLIGHT);
	m_clrTextSelectedItem = GetSysColor(COLOR_HIGHLIGHTTEXT);
