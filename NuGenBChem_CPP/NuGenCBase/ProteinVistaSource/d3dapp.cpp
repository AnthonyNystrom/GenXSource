...
EndWindowedDeviceComboSearch:
	...
	//	디폴트 MultiSample
	//	multisample 의 디폴트값 수정	2 is D3DMULTISAMPLE_2_SAMPLES
	//	void CProteinVistaRenderer::SetAntialiasing() 에서 다시 device를 만든다.
	/*
	if ( pBestDeviceCombo->pMultiSampleTypeList->Count() >= 2 )
	{
		m_d3dSettings.Windowed_MultisampleType = *(D3DMULTISAMPLE_TYPE*)pBestDeviceCombo->pMultiSampleTypeList->GetPtr(2);
	}
	*/
...
HRESULT CD3DApplication::HandlePossibleSizeChange()
{
        ...
        m_rcWindowClient.bottom - m_rcWindowClient.top)
    {
        ...
        m_d3dpp.BackBufferWidth  = m_rcWindowBounds.right - m_rcWindowBounds.left;
        m_d3dpp.BackBufferHeight = m_rcWindowBounds.bottom - m_rcWindowBounds.top;
...
HRESULT CD3DApplication::Initialize3DEnvironment()
{
    ...
    if (m_d3dSettings.GetVertexProcessingType() == SOFTWARE_VP)
        ...
        behaviorFlags = 0; // throw exception
...
#ifdef DEBUG_VS
	if( m_d3dSettings.DevType() != D3DDEVTYPE_REF )
	{
		behaviorFlags &= ~D3DCREATE_HARDWARE_VERTEXPROCESSING;
...
#endif
#ifdef DEBUG_PS
	m_d3dSettings.pWindowed_DeviceCombo->DevType = D3DDEVTYPE_REF;
	//    m_d3dSettings.DevType= D3DDEVTYPE_REF;
#endif
...
INT CD3DApplication::Run()
{
    ...
    HACCEL hAccel = NULL;	//	LoadAccelerators( NULL, MAKEINTRESOURCE(IDR_MAIN_ACCEL) );
