...
namespace Genetibase.NuGenAnnotation
{
	...
	/// </summary>
	//[Serializable]
	public class DrawImage : Genetibase.NuGenAnnotation.DrawObject
	{
		...
		public override DrawObject Clone()
		{
			...
			drawImage._image = this._image;
			drawImage._originalImage = this._originalImage;
			drawImage.rectangle = this.rectangle;
