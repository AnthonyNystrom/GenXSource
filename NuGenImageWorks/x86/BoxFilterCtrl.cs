...
namespace Genetibase.UI.NuGenImageWorks
{
    public partial class BoxFilterCtrl : UserControl
    {
        ...
        public BoxFilterProp BoxFilterProp
        {
            get 
            {
                return new BoxFilterProp((int)numericUpDown1.Value, (int)numericUpDown2.Value,label5.BackColor,label6.BackColor,checkBox1.Checked);
            }
            set
            {
                bf = new BoxFilterProp(value.BoxDepth,value.Angle,value.BoxStartColor,value.BoxEndColor,value.DrawImageOnSides);
