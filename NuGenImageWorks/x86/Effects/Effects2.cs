...
namespace Genetibase.UI.NuGenImageWorks
{
    public class Effects2
    {
        ...
        public static int sharpen = 0;

        public static bool grayscale = false;
        public static bool dropshadow = false;
        public static bool rounded = false;

        public static bool wash = false;
        public static Color washColor = Color.Empty;
        private static RotateFlipType rotate = RotateFlipType.RotateNoneFlipNone;

        private static RotateFlipType flip = RotateFlipType.RotateNoneFlipNone;

        private static BoxFilterProp boxFilter = new BoxFilterProp(30, 0,Color.DarkBlue,Color.LightBlue,false);
        ...
        {
            get { return Effects2.floorReflectionFilter; }
            set { Effects2.floorReflectionFilter = value; }
        }
        ...
        {
            get { return Effects2.boxFilter; }
            set { Effects2.boxFilter = value; }
        }        

        public static RotateFlipType Rotate
        {
            get { return Effects2.rotate; }
            set 
            {
                Effects2.rotate = (RotateFlipType)(((int)Effects2.rotate + (int)value) % 4); 
            }
        }

        public static RotateFlipType RotateForUndo
        {
            get { return Effects2.rotate; }
            set
            {
                Effects2.rotate = value;
            }
        }

        public static RotateFlipType Flip
        {
            get { return Effects2.flip; }
            set
            {
                if (Effects2.flip == value)
                    Effects2.flip = RotateFlipType.RotateNoneFlipNone;

                else if ((int)value == 6)
                {
                    Effects2.flip = (RotateFlipType)( (int)value - (int)Effects2.flip );
                }

                else if ((int)value == 4)
                {
                    if( (int)Effects2.flip > 4 )
                        Effects2.flip = (RotateFlipType)((int)Effects2.flip - (int)value);
                    else
                        Effects2.flip = (RotateFlipType)((int)value + (int)Effects2.flip);
                }
                else
        ...
        public static RotateFlipType FlipForUndo
        {
            get { return Effects2.flip; }
            set
            {
        ...
        public static void Do(Bitmap b)
        {
            if (brightness != 0)
       ...
       /* internal static void FillRoundedRectangle(Graphics g, Rectangle r, int d, Brush b)
        ...
        public static void Transparency(Bitmap img, int alpha)
        {
            Bitmap b = img;
        ...
        public static void Sharpen(Bitmap img, int nWeight /* default to 11*/ )
        {
            Bitmap b = img;
            ConvMatrix m = new ConvMatrix();
            m.SetAll(0);
        ...
        public static void Brightness(Bitmap img, int nBrightness)
        {
            Bitmap b = img;
        ...
        public static void Contrast(Bitmap img, int nContrast)
        {
            Bitmap b = img;
        ...
        public static Bitmap DropShadow(Bitmap img, int Offset, int Steps)
        {
            ...
            for (int i = 0; i <= Steps; i++)
            {
                ...
                if (!Rounded)
                    ...
                    Genetibase.UI.NuGenImageWorks.Grpahics.FillRoundedRectangle(g, b, Offset, Offset, Width - i, Height - i, 30);
