...
BEGIN_MESSAGE_MAP(CEGSplitterWnd, CSplitterWnd)
END_MESSAGE_MAP()


/////////////////////////////////////////////////////////////////////////////
// CEGSplitterWnd message handlers

void CEGSplitterWnd::OnDrawSplitter(CDC* pDC, ESplitType nType, const CRect& rectArg)
{
...
void CEGSplitterWnd::LayoutRowCol(CSplitterWnd::CRowColInfo* pInfoArray,
...
void CEGSplitterWnd::DeferClientPos(AFX_SIZEPARENTPARAMS* lpLayout,
...
void CEGSplitterWnd::RecalcLayout()
{
	ASSERT_VALID(this);
