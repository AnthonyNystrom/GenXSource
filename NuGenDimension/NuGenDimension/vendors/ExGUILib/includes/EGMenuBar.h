...
/////////////////////////////////////////////////////////////////////////////
// CEGBarItem menubar item for drawing
class GUILIBDLLEXPORT CEGBarItem: public CObject
{
public:
  CRect m_ItemRect;
  UINT m_nSyncFlag;
...
/////////////////////////////////////////////////////////////////////////////
// CEGMenuBarItem for drawing
class GUILIBDLLEXPORT CEGMenuBarItem: public CEGBarItem
{
public:
  HMENU m_hMenu;
  UINT m_nIndex;

	DECLARE_DYNAMIC( CEGMenuBarItem );

public:
  CEGMenuBarItem(HMENU hMenu, UINT nIndex);
...
/////////////////////////////////////////////////////////////////////////////
// CEGIconBarItem menu bar icons for drawing
class GUILIBDLLEXPORT CEGIconBarItem: public CEGBarItem
{
public:
  HBITMAP m_hBitmap;
  UINT m_uCommandID;
...
public:
  CEGIconBarItem(HBITMAP hBitmap,UINT uCommandID);
...
/////////////////////////////////////////////////////////////////////////////
// CEGMenuBar for docking
class GUILIBDLLEXPORT CEGMenuBar : public CControlBar
{
  DECLARE_DYNAMIC(CEGMenuBar)
...
public:
  ...
  CTypedPtrArray<CPtrArray, CEGBarItem*> m_NewBarItemList;

  void DeleteNewBarItemList();

private:
  static CTypedPtrMap<CMapPtrToPtr,HWND,CEGMenuBar*> m_NewMenuBar;
