...
#pragma once
#endif // _MSC_VER > 1000
// EGPropertyGridItemCombo.h : header file
//
...
/////////////////////////////////////////////////////////////////////////////
// CEGPropertyGridItemCombo window

class GUILIBDLLEXPORT CEGPropertyGridItemCombo : public CComboBox, public CEGPropertyGridItem
{
// Construction
public:
	CEGPropertyGridItemCombo();
	virtual ~CEGPropertyGridItemCombo();
...
// Overrides
	...
	//{{AFX_VIRTUAL(CEGPropertyGridItemCombo)
	//}}AFX_VIRTUAL
...
protected:
	//{{AFX_MSG(CEGPropertyGridItemCombo)
