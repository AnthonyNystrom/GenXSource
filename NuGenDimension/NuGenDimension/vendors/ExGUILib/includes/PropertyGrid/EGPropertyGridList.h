...
#pragma once
#endif // _MSC_VER > 1000
// EGPropertyGridList.h : header file
//
...
/////////////////////////////////////////////////////////////////////////////
// CEGPropertyGridList window

#include "EGMenu.h"

class GUILIBDLLEXPORT CEGPropertyGridList : public CWnd
{
// Construction
public:
	CEGPropertyGridList();
	virtual ~CEGPropertyGridList();
...
// Overrides
	...
	//{{AFX_VIRTUAL(CEGPropertyGridList)
	//}}AFX_VIRTUAL
