...
#pragma once
#endif // _MSC_VER > 1000
// EGPropertyGridItemEdit.h : header file
//
...
/////////////////////////////////////////////////////////////////////////////
// CEGPropertyGridItemEdit window

class GUILIBDLLEXPORT CEGPropertyGridItemEdit : public CEdit, public CEGPropertyGridItem
{
// Construction
public:
	CEGPropertyGridItemEdit();
	virtual ~CEGPropertyGridItemEdit();
...
// Overrides
	...
	//{{AFX_VIRTUAL(CEGPropertyGridItemEdit)
	//}}AFX_VIRTUAL
...
protected:
	//{{AFX_MSG(CEGPropertyGridItemEdit)
