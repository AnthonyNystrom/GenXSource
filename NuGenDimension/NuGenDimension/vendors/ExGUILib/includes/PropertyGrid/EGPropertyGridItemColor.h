...
#pragma once
#endif // _MSC_VER > 1000
// EGPropertyGridItemColor.h : header file
//
...
/////////////////////////////////////////////////////////////////////////////
// CEGPropertyGridItemColor window

class GUILIBDLLEXPORT CEGPropertyGridItemColor : public CWnd, public CEGPropertyGridItem
{
// Construction
public:
	CEGPropertyGridItemColor();
	virtual ~CEGPropertyGridItemColor();
...
// Overrides
	...
	//{{AFX_VIRTUAL(CEGPropertyGridItemColor)
	//}}AFX_VIRTUAL
...
protected:
	//{{AFX_MSG(CEGPropertyGridItemColor)
