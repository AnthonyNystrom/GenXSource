#ifndef __Coons4Command__
#define __Coons4Command__

class Coons4Command : public ICommander, public IContextMenuInterface
{
	IApplicationInterface* m_app;
private:
	
	IGetObjectsPanel*      m_get_object_panels[4];
...
public:
	Coons4Command(IApplicationInterface* appI);
	virtual ~Coons4Command();
