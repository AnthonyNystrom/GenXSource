...
extern "C"  AFX_EXTENSION_MODULE TDDLL;
...
public:
	DllInstanceSwitcher()
	{
		...
		AfxSetResourceHandle(TDDLL.hResource);
	}
	~DllInstanceSwitcher()
	{
...
extern int     text_name_index;
extern int     linear_dim_name_index;
extern int     ang_dim_name_index;
extern int     rad_dim_name_index;
extern int     dim_dim_name_index;
