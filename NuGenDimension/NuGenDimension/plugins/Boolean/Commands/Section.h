#ifndef __SectionCommand__
#define __SectionCommand__


class SectionCommand : public ICommander, public IContextMenuInterface
{
	IApplicationInterface* m_app;
private:
	CString m_message;
public:
	SectionCommand(IApplicationInterface* appI);
	virtual ~SectionCommand();
