...
{
	/// <summary>
	/// Provides a type converter to convert Point2D objects to and from various other representations.
	/// </summary>
    public class Point2DConverter : TypeConverter
    {
        ...
        public override object ConvertFrom(ITypeDescriptorContext context, System.Globalization.CultureInfo culture, object value)
        {
            ...
            {
                return new Point2D(numArray1[0], numArray1[1]);
            }
            object[] objArray1 = new object[] { text1, "x, y" };
        ...
        public override object ConvertTo(ITypeDescriptorContext context, CultureInfo culture, object value, Type destinationType)
        {
            ...
            if ((destinationType == typeof(InstanceDescriptor)) && (value is Point2D))
            {
                Point2D point2 = (Point2D)value;
                Type[] typeArray1 = new Type[] { typeof(double), typeof(double) };
                ConstructorInfo info1 = typeof(Point2D).GetConstructor(typeArray1);
                if (info1 != null)
                {
                    object[] objArray1 = new object[] { point2.X, point2.Y };
        ...
        {
            PropertyDescriptorCollection collection1 = TypeDescriptor.GetProperties(typeof(Point2D), attributes);
            string[] textArray1 = new string[] { "X", "Y" };
