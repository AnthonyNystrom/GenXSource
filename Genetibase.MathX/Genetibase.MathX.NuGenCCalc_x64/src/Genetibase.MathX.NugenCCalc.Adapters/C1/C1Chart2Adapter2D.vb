...
Namespace C1
    ...
    Public Class C1Chart2Adapter2D
...
#End Region
        ...
        Private Function SeriesToSeriesIndex(ByVal series As Series) As Integer
            ...
            Next num2
            If (num1 = -1) Then
                Dim series1 = [Assembly].LoadWithPartialName("C1.Win.C1Chart.2, Culture=neutral, PublicKeyToken=a22e16972c085838").CreateInstance("C1.Win.C1Chart.ChartDataSeries")
        ...
        Public Function Validate(ByVal obj As Object) As Boolean Implements IChartAdapter.IChartAdapter.Validate
            If (obj.GetType.Name = "C1Chart" And obj.GetType.Assembly.ImageRuntimeVersion(1) = "2") Then
                Return True
            End If
            Return False
        End Function
        ...
        Public Overloads Sub Plot(ByVal values() As Double, ByVal seriesIndex As Integer) Implements IChartAdapter.IChartAdapter2D.Plot
            ...
            Else
                series1 = [Assembly].LoadWithPartialName("C1.Win.C1Chart.2, Culture=neutral, PublicKeyToken=a22e16972c085838").CreateInstance("C1.Win.C1Chart.ChartDataSeries")
                series1.LineStyle.Pattern = LinePatternEnumNone
                series1.SymbolStyle.Shape = SymbolShapeEnumDot
                series1.SymbolStyle.Size = 1
