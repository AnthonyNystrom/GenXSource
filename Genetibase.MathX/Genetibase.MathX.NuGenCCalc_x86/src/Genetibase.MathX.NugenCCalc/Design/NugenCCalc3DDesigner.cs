...
namespace Genetibase.MathX.NugenCCalc.Design
{
	...
	/// </summary>
	public class NugenCCalc3DDesigner : ComponentDesigner
	{

		public NugenCCalc3DDesigner()
		{
		...
		{
			if (this.Component is NugenCCalc3D)
			{
				NugenCCalc3DDesignerForm designerForm = new NugenCCalc3DDesignerForm((NugenCCalc3D)this.Component);
		...
		protected override void PreFilterProperties(System.Collections.IDictionary properties)
		{
			...
			properties[propName] = new Function3DTypePropertyDescriptor(this, 
				TypeDescriptor.CreateProperty(
				Component.GetType(),
				propName,
				typeof(FunctionType3D),
				new Attribute[] 
					{
