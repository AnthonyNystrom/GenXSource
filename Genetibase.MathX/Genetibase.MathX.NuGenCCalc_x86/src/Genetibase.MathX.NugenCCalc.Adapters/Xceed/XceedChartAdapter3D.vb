...
Namespace Xceed
    <ToolboxBitmap(GetType(XceedChartAdapter3D), "Chart.ChartControl.bmp")> _
       Public Class XceedChartAdapter3D
        ...
        Public Sub PlotPoints(ByVal points As Point3D()) Implements IChartAdapter3D.PlotPoints
            ...
            If (Not points Is Nothing) Then
                ...
                Dim tdo = [Assembly].LoadWithPartialName("Xceed.Chart.GraphicsCore, Culture=neutral, PublicKeyToken=ba83ff368b7563c6").CreateInstance("Xceed.Chart.GraphicsCore.TrackballDragOperation")
        ...
        Public Sub PlotSurface(ByVal gridLeftBottom As Point2D, ByVal gridRightTop As Point2D, ByVal values(,) As Double) Implements IChartAdapter3D.PlotSurface
            If (Not values Is Nothing) Then
                ...
                chart1.Axis(StandardAxisDepth).NumericScale.AutoMax = True
                chart1.Axis(StandardAxisDepth).NumericScale.AutoMin = True
                Dim series1 = [Assembly].LoadWithPartialName("Xceed.Chart.Core, Culture=neutral, PublicKeyToken=ba83ff368b7563c6").CreateInstance("Xceed.Chart.Core.MeshSurfaceSeries")
