...
Namespace Nevron
    <ToolboxBitmap(GetType(NevronChartAdapter2D), "NChart.NChartControl.bmp")> _
        Public Class NevronChartAdapter2D
        ...
        Private Function AddNewSeriesPolar(ByVal seriesName As String) As Integer
            Dim series1 = [Assembly].LoadWithPartialName("Nevron.NChartCore, Culture=neutral, PublicKeyToken=2961c51bb98125d2").CreateInstance("Nevron.NChart.NPolarSeries")
            If seriesName <> "" Then
                series1.set_Name(seriesName)
            End If
        ...
        Public Sub Plot(ByVal points As Point2D(), ByVal seriesIndex As Integer) Implements IChartAdapter2D.Plot
            ...
            If (((seriesIndex >= 0) AndAlso (seriesIndex < Me._chart.get_Charts.get_Item(0).get_Series.Count)) AndAlso (Me._chart.get_Charts.get_Item(0).get_Series.get_Item(seriesIndex).GetType.BaseType.Name = "NXYScatterSeries")) Then
        ...
        Public Sub PlotPolar(ByVal points As Point2D(), ByVal seriesIndex As Integer) Implements IChartAdapter2D.PlotPolar
            ...
            Me._chart.get_Charts.get_Item(0).Axis(2).set_ScaleMode(1)
            Me._chart.get_Charts.get_Item(0).Axis(0).set_ScaleMode(1)
            If (((seriesIndex >= 0) AndAlso (seriesIndex < Me._chart.get_Charts.get_Item(0).get_Series.Count)) AndAlso (Me._chart.get_Charts.get_Item(0).get_Series.get_Item(seriesIndex).GetType.Name = "NPolarSeries")) Then
                series1 = Me._chart.get_Charts.get_Item(0).get_Series.get_Item(seriesIndex)
                series1.get_Values.Clear()
            Else
        ...
        Public Sub PlotPolar(ByVal values As Double(), ByVal series As Series) Implements IChartAdapter2D.PlotPolar
            ...
            If (((series.Index >= 0) AndAlso (series.Index < Me._chart.get_Charts.get_Item(0).get_Series.Count)) AndAlso (Me._chart.get_Charts.get_Item(0).get_Series.get_Item(seriesIndex).GetType.Name = "NPolarSeries")) Then
        ...
        Private Function SeriesNameToSeriesIndexPolar(ByVal seriesName As String) As Integer
            ...
            Dim num2 As Integer = 0
            Do While (num2 < Me._chart.get_Charts.get_Item(0).get_Series.Count)
                If ((Me._chart.get_Charts.get_Item(0).get_Series.get_Item(num2).get_Name Is seriesName) AndAlso (Me._chart.get_Charts.get_Item(0).get_Series.get_Item(num2).GetType.BaseType.Name = "NPolarSeries")) Then
                    num1 = num2
                    Exit Do
                End If
                num2 += 1
