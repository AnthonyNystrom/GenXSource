    ...
    Public Class C1ChartAdapter3D
        ...
        Public Sub PlotPoints(ByVal points As Point3D()) Implements IChartAdapter3D.PlotPoints
            If (Not points Is Nothing) Then
                ...
                Dim pointArray1 = Array.CreateInstance([Assembly].LoadWithPartialName("C1.Win.C1Chart3D, Culture=neutral, PublicKeyToken=a22e16972c085838").GetType("C1.Win.C1Chart3D.Chart3DPoint"), (points.Length))
                Dim pointType = [Assembly].LoadWithPartialName("C1.Win.C1Chart3D, Culture=neutral, PublicKeyToken=a22e16972c085838").GetType("C1.Win.C1Chart3D.Chart3DPoint")
        ...
        Public Function Validate(ByVal obj As Object) As Boolean Implements IChartAdapter.IChartAdapter.Validate
            If (obj.GetType.Name = "C1Chart3D" And obj.GetType.Assembly.ImageRuntimeVersion(1) = "1") Then
                Return True
            End If
            Return False
        End Function
