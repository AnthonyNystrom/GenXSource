...
namespace Genetibase.MathX.NeGenProbability
{
    ...
    public abstract class NuGenProbability
    {
        ...
        public NuGenProbability(int rv, RandomVariableType rvt)
            : this(rv, rvt, UNDEFINED)
        {

        }

        public NuGenProbability(int rv)
            : this(rv, RandomVariableType.EQUAL, UNDEFINED)
        {

        }

        public NuGenProbability()
            : this(0, RandomVariableType.EQUAL, UNDEFINED)
        {
    ...
    class NuGenProbabilityException : Exception
    {
        ...
        public NuGenProbabilityException(string whatString)
            : base(whatString)
        {
