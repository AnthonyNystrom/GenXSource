Public Class NuGenInterPolationForCordicForm
    ...
    Private Sub CosH_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CosH.Click
        ...
        Else
            result.Text = Genetibase.MathX.NuGenHyperbolicTrignometricFunction.NuGenInterpolation2.COSH(Val(first_no))
        End If
    ...
    Private Sub SinH_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SinH.Click
        If first_no.Text = "" Then
            MsgBox("Please Enter The Number")
        Else
            result.Text = Genetibase.MathX.NuGenHyperbolicTrignometricFunction.NuGenInterpolation2.SINH(Val(first_no))
        End If
    End Sub
    ...
    Private Sub TanH_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TanH.Click
        If first_no.Text = "" Then
            MsgBox("Please Enter The Number")
        Else
            result.Text = Genetibase.MathX.NuGenHyperbolicTrignometricFunction.NuGenInterpolation2.TANH(Val(first_no))
        End If
    End Sub
    ...
    Private Sub InvCosH_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles InvCosH.Click
        If first_no.Text = "" Then
            MsgBox("Please Enter The Number")
        Else
            result.Text = Genetibase.MathX.NuGenHyperbolicTrignometricFunction.NuGenInterpolation2.INVCOSH(Val(first_no))
        End If
    End Sub
    ...
    Private Sub InvSinH_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles InvSinH.Click
        If first_no.Text = "" Then
            MsgBox("Please Enter The Number")
        Else
            result.Text = Genetibase.MathX.NuGenHyperbolicTrignometricFunction.NuGenInterpolation2.INVSINH(Val(first_no))
        End If
    End Sub
    ...
    Private Sub InvTanH_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles InvTanH.Click
        If first_no.Text = "" Then
            MsgBox("Please Enter The Number")
        Else
            result.Text = Genetibase.MathX.NuGenHyperbolicTrignometricFunction.NuGenInterpolation2.INVTANH(Val(first_no))
        End If
    End Sub
