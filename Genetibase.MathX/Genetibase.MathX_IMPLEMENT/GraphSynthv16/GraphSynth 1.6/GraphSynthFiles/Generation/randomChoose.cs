...
{
    public class randomChoose : RecognizeChooseApply
    {
        ...
        public randomChoose(designGraph _seed, ruleSet[] _rulesets, int _maxRulesToApply,
            Boolean recompileRules, string execDir, string compiledparamRules)
            : base(_seed, _rulesets, _maxRulesToApply, false, recompileRules, execDir, compiledparamRules) { }
        public randomChoose(designGraph _seed, ruleSet[] _rulesets, int _maxRulesToApply, Boolean _display,
             Boolean recompileRules, string execDir, string compiledparamRules)
            : base(_seed, _rulesets, _maxRulesToApply, _display, recompileRules, execDir, compiledparamRules) { }
        public randomChoose(designGraph _seed, ruleSet[] _rulesets, int[] _maxNumOfCalls, Boolean _display,
             Boolean recompileRules, string execDir, string compiledparamRules)
            : base(_seed, _rulesets, _maxNumOfCalls, _display, recompileRules, execDir, compiledparamRules) { }
        public randomChoose(designGraph _seed, ruleSet[] _rulesets, Boolean _display)
            : base(_seed, _rulesets, -1, _display) { }
        public randomChoose(designGraph _seed, ruleSet[] _rulesets)
            : base(_seed, _rulesets, -1, false) { }
        public randomChoose(designGraph _seed, ruleSet[] _rulesets, int[] _maxNumOfCalls)
