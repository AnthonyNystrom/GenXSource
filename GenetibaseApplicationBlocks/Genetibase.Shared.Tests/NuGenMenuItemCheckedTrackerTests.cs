...
namespace Genetibase.Shared.Tests
{
	...
	public class NuGenMenuItemCheckedTrackerTests
	{
		...
		{
			_checkedTracker.CheckedChanged(null, _menuItem);
		}
		...
		public void CheckedChangedArgumentNullExceptionOnMenuItemTest()
		{
			...
			_checkedTracker.CheckedChanged((INuGenMenuItemGroup)groupMock.Object, null);
		}
