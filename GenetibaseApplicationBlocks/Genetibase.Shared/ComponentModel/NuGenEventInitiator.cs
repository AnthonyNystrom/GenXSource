...
namespace Genetibase.Shared.ComponentModel
{
	...
	public abstract class NuGenEventInitiator
	{
		...
		/// </exception>
		protected void InvokeActionT<T>(object key, T e) where T : EventArgs
		{
		...
		/// </exception>
		protected void InvokeAction(object key, EventArgs e)
		{
			Debug.Assert(this.Initiator != null, "this.Initiator != null");
		...
		/// </exception>
		protected void InvokeMouseAction(object key, MouseEventArgs e)
		{
			Debug.Assert(this.Initiator != null, "this.Initiator != null");
		...
		/// with <see cref="MouseEventHandler"/>.
		/// </exception>
		protected void InvokePropertyChanged(object key, EventArgs e)
		{
			Debug.Assert(this.Initiator != null, "this.Initiator != null");
