...
namespace Genetibase.Shared.Controls
{
	...
	public class NuGenToolStripTrackBar : ToolStripControlHost
	{
		...
		protected override void OnSubscribeControlEvents(Control control)
		{
			...
			trackBar.LargeChangeChanged += trackBar_LargeChangeChanged;
			trackBar.MaximumChanged += trackBar_MaximumChanged;
			trackBar.MinimumChanged += trackBar_MinimumChanged;
			trackBar.SmallChangeChanged += trackBar_SmallChangeChanged;
			trackBar.TickStyleChanged += trackBar_TickStyleChanged;
		...
		private void trackBar_LargeChangeChanged(object sender, EventArgs e)
		{
			this.OnLargeChangeChanged(e);
		}

		private void trackBar_MaximumChanged(object sender, EventArgs e)
		{
			this.OnMaximumChanged(e);
		}

		private void trackBar_MinimumChanged(object sender, EventArgs e)
		{
			this.OnMinimumChanged(e);
		}

		private void trackBar_SmallChangeChanged(object sender, EventArgs e)
		{
			this.OnSmallChangeChanged(e);
		}

		private void trackBar_TickStyleChanged(object sender, EventArgs e)
		{
