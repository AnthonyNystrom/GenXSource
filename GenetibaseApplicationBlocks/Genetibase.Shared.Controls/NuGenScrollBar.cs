...
namespace Genetibase.Shared.Controls
{
	...
	public partial class NuGenScrollBar : NuGenOrientationControlBase
	{
		...
		private ScrollButton _leftTopButton;
		private ScrollButton _rightBottomButton;
		...
		private static readonly int _defaultLargeChange = 5;
		...
		private static readonly int _defaultMaximum = 10;
		...
		private static readonly int _defaultMinimum = 0;
		...
		private static readonly int _defaultSmallChange = 1;
		...
		private static readonly int _defaultValue = 0;
		...
		private void BuildLayout()
		{
			...
			else
			{
				...
				_leftTopTrack.Height = _sizeBox.Top - _leftTopButton.Bottom;
				...
				_rightBottomTrack.Height = _rightBottomButton.Top - _sizeBox.Bottom;
			}
		...
		private int GetSizeBoxDimension(int scrollAreaDimension)
		{
			...
			{
				sizeBoxDimension = scrollAreaDimension * 9 / (this.Maximum - this.Minimum);
			}
