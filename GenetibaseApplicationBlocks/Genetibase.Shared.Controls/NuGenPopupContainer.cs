...
namespace Genetibase.Shared.Controls
{
	...
	public partial class NuGenPopupContainer : Component
	{
		...
		{
			this.Initiator.InvokeAction(_popupClosing, e);
		}
		...
		{
			this.PopupSize = this.DefaultPopupSize;
		}

		private bool ShouldSerializePopupSize()
		{
			return this.PopupSize != this.DefaultPopupSize;
		}
