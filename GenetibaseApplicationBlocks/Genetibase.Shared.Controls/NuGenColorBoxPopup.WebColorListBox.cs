...
namespace Genetibase.Shared.Controls
{
	...
	{
		private sealed class WebColorListBox : ColorListBox
		{
			#region Constructors

			/// <summary>
			/// Initializes a new instance of the <see cref="WebColorListBox"/> class.
			/// </summary>
			...
			public WebColorListBox(INuGenServiceProvider serviceProvider)
				: base(serviceProvider)
			{
				List<Color> colors = null;
				this.ColorsProvider.FillWithWebColors(out colors);
