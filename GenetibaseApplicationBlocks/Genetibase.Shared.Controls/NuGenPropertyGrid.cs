...
namespace Genetibase.Shared.Controls
{
	...
	public class NuGenPropertyGrid : PropertyGrid
	{
		...
		private void doccomment_Paint(object sender, PaintEventArgs e)
		{
			...
			this.Renderer.DrawDocComment(new NuGenPaintParams(this, e.Graphics, _doccomment.Properties["ClientRectangle"].GetValue<Rectangle>(), this.StateTracker.GetControlState()));
		}
