...
namespace Genetibase.Shared.Controls
{
	...
	/// </summary>
	[ToolboxItem(false)]
	[Designer(typeof(NuGenDropDownDesigner))]
	[System.ComponentModel.DesignerCategory("Code")]
	public class NuGenDropDown : NuGenUIControlBase
	{
		...
		protected virtual void OnDropDown(EventArgs e)
		{
			...
			this.Initiator.InvokeAction(_dropDown, e);
		}
		...
		{
			this.Initiator.InvokeAction(_dropDownClosed, e);
		}
		...
		protected override void OnPaint(PaintEventArgs e)
		{
			...
			NuGenItemPaintParams paintParams = new NuGenItemPaintParams(this, g, bodyBounds, bodyState);
			...
			this.Renderer.DrawDropDownButton(new NuGenPaintParams(this, g, dropDownBounds, buttonState));
			this.Renderer.DrawBorder(new NuGenPaintParams(this, g, bounds, buttonState));
		}
		...
		private Rectangle GetBodyBounds(Rectangle dropDownButtonBounds)
		{
			if (this.RightToLeft == RightToLeft.No)
			{
				return new Rectangle(
					...
					this.ClientRectangle.Width - (this.ClientRectangle.Right - dropDownButtonBounds.Left),
			...
			return new Rectangle(
				...
				this.ClientRectangle.Top,
				this.ClientRectangle.Width - dropDownButtonBounds.Right,
				this.ClientRectangle.Height
			);
		}
