...
namespace Genetibase.Shared.Controls
{
	partial class NuGenTextBox
	{
		...
		protected class PromptTextBox : TextBox
		{
			...
			/// <returns></returns>
			protected string AddBeginningOfStringAndEndOfStringMetacharacters(string str)
			{
				str = "^(" + str + ")$";
			...
			/// <param name="str"></param>
			/// <returns></returns>
			protected string AddCharacterCollectionMetacharacters(string str)
			{
				if (str.Length != 0)
				{
			...
			{
				_regex = this.GetRegex(this.GetRegexString());
			}
			...
			/// <param name="str"></param>
			/// <returns></returns>
			protected string ReplaceWildcardCharacters(string str)
			{
				str = str.Replace("*", "(.+)");
				str = str.Replace("?", "(.)");
