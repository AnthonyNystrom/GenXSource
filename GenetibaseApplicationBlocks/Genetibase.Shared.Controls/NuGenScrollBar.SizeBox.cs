...
namespace Genetibase.Shared.Controls
{
	partial class NuGenScrollBar
	{
		/// <summary>
		/// </summary>
		private sealed class SizeBox : ScrollPart
		{
			...
			protected override void OnPaint(PaintEventArgs e)
			{
				...
				{
					this.Renderer.DrawSizeBox(new NuGenPaintParams(
						this,
						e.Graphics,
			...
			/// <summary>
			/// Initializes a new instance of the <see cref="SizeBox"/> class.
			/// </summary>
			...
			public SizeBox(INuGenServiceProvider serviceProvider)
