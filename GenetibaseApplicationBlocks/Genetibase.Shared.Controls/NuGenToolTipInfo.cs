...
namespace Genetibase.Shared.Controls
{
	...
	public sealed class NuGenToolTipInfo
	{
		...
		internal bool IsHeaderVisible
		{
			get
			{
				return this.CheckStringVisible(_header);
			}
		}
		...
		internal bool IsImageVisible
		{
			get
			{
				return this.CheckImageVisible(_image);
			}
		}
		...
		internal bool IsTextVisible
		{
			get
			{
				return this.CheckStringVisible(_text);
			}
		}
		...
		internal bool IsRemarksHeaderVisible
		{
			get
			{
				return this.CheckStringVisible(_remarksHeader);
			}
		}
		...
		internal bool IsRemarksImageVisible
		{
			get
			{
				return this.CheckImageVisible(_remarksImage);
			}
		}
		...
		internal bool IsRemarksVisible
		{
			get
			{
				return this.CheckStringVisible(_remarks);
			}
		}
		...
		private bool CheckImageVisible(Image value)
		{
			return value != null;
		}

		private bool CheckStringVisible(string value)
		{
