	...
	partial class NuGenColorBoxPopup
	{
		private sealed class ColorPanel : NuGenPanel
		{
			...
			protected override void OnPaint(PaintEventArgs e)
			{
				...
				Rectangle displayColorRectangle = Rectangle.Inflate(bounds, -1, -1);
				...
				{
					g.FillRectangle(sb, displayColorRectangle);
				}

				if (
					currentState == NuGenControlState.Normal
					|| currentState == NuGenControlState.Focused
					)
				{
					borderRectangle = displayColorRectangle;
				}
