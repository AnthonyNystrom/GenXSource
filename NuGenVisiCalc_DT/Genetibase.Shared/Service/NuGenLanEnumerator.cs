...
namespace Genetibase.Shared.Service
{
	...
	public class NuGenLanEnumerator : IEnumerator
	{
		...
		protected internal NuGenLanEnumerator(uint serverType) : this(serverType, null)
		{
		}
	...
	public class NuGenLanItems : IEnumerable	
	{
		...
		{	
			return new NuGenLanEnumerator(serverType, domainName);
		}		
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="T:NuGenLanItems"/> class.
		/// </summary>
		public NuGenLanItems() : this(0)
		{			
		}
