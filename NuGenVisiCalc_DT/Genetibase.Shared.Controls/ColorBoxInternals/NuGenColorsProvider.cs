...
namespace Genetibase.Shared.Controls.ColorBoxInternals
{
	...
	public sealed class NuGenColorsProvider : INuGenColorsProvider
	{
		...
		private static readonly IList<Color> _customColors;
		...
		public void FillWithCustomColors(out IList<Color> customColors)
		{
		...
		private static readonly IList<Color> _standardColors;

		/// <summary>
		/// </summary>
		/// <param name="standardColors"></param>
		public void FillWithStandardColors(out IList<Color> standardColors)
		{
		...
		private static readonly IList<Color> _webColors;

		/// <summary>
		/// </summary>
		/// <param name="webColors"></param>
		public void FillWithWebColors(out IList<Color> webColors)
		{
