...
namespace Genetibase.Shared.Controls
{
	...
	public sealed class NuGenTabButton : Button
	{
		...
		{
			this.Initiator.InvokeEventHandler(_close, e);
		}
		...
		private NuGenCloseButton _closeButton = null;

		/// <summary>
		/// Read-only.
		/// </summary>
		private NuGenCloseButton CloseButton
		{
			get
			{
				if (_closeButton == null)
				{
					...
					_closeButton = new NuGenCloseButton(this.ServiceProvider);
				}
		...
		/// <summary>
		/// Raises the enabled changed event.
		/// </summary>
		/// <param name="e">The <see cref="System.EventArgs"/> instance containing the event data.</param>
		protected override void OnEnabledChanged(EventArgs e)
		{
			this.TabStateTracker.Enabled(this.Enabled);
