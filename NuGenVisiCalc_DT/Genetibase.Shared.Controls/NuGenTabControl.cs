...
namespace Genetibase.Shared.Controls
{
	...
	/// </summary>
	[ToolboxItem(true)]
	[ToolboxBitmap(typeof(NuGenTabControl), "Resources.NuGenIcon.png")]
	[DefaultEvent("TabIndexChanged")]
	[DefaultProperty("Dock")]
	[Designer("Genetibase.Shared.Controls.Design.NuGenTabControlDesigner")]
	[NuGenSRDescription("Description_TabControl")]
	...
	public partial class NuGenTabControl : UserControl
	{
		...
		public int SelectedIndex
		{
			...
			set
			{
				...
				{
					NuGenTabButton tabButtonToSelect = _tabButtons[value];
					Debug.Assert(_buttonPageDictionary != null, "_buttonPageDictionary != null");
		...
		{
			Debug.Assert(this.Initiator != null, "this.Initiator != null");
			this.Initiator.InvokeEventHandler(_selectedIndexChanged, e);
		}
		...
		private NuGenTabLayoutBuilder _layoutBuilder;
		...
		/// <returns></returns>
		public NuGenTabControlHitResult HitTest(Point pointToTest)
		{
			...
			if (this.ClientRectangle.Contains(cp))
			{
				foreach (NuGenTabButton tabButton in _tabButtons)
				{
					...
					{
						return NuGenTabControlHitResult.TabButtons;
					}
				}

				return NuGenTabControlHitResult.Body;
			}

			return NuGenTabControlHitResult.Nowhere;
		}
		...
		private void _tabButton_Click(object sender, EventArgs e)
		{
		...
		private void _tabButton_DoubleClick(object sender, EventArgs e)
		{
			this.OnTabButtonDoubleClick(sender, e);
		}

		private void _tabButton_DragDrop(object sender, DragEventArgs e)
		{
			this.OnTabButtonDragDrop(sender, e);
		}

		private void _tabButton_DragEnter(object sender, DragEventArgs e)
		{
			this.OnTabButtonDragEnter(sender, e);
		}

		private void _tabButton_DragLeave(object sender, EventArgs e)
		{
			this.OnTabButtonDragLeave(sender, e);
		}

		private void _tabButton_MouseDown(object sender, MouseEventArgs e)
		{
			this.OnTabButtonMouseDown(sender, e);
		}

		private void _tabButton_MouseEnter(object sender, EventArgs e)
		{
			this.OnTabButtonMouseEnter(sender, e);
		}

		private void _tabButton_MouseHover(object sender, EventArgs e)
		{
			this.OnTabButtonMouseHover(sender, e);
		}

		private void _tabButton_MouseLeave(object sender, EventArgs e)
		{
			this.OnTabButtonMouseLeave(sender, e);
		}

		private void _tabButton_MouseMove(object sender, MouseEventArgs e)
		{
			this.OnTabButtonMouseMove(sender, e);
		}

		private void _tabButton_MouseUp(object sender, MouseEventArgs e)
		{
		...
		private void _tabPage_TabButtonImageChanged(object sender, EventArgs e)
		{
			Debug.Assert(sender is NuGenTabPage, "sender is NuGenTabPage");
			NuGenTabPage tabPage = (NuGenTabPage)sender;
			...
			Debug.Assert(_pageButtonDictionary != null, "_pageButtonDictionary != null");
			Debug.Assert(_pageButtonDictionary.ContainsKey(tabPage), "_pageButtonDictionary.ContainsKey(tabPage)");
			_pageButtonDictionary[tabPage].Image = tabPage.TabButtonImage;
		}
		...
		public NuGenTabControl(INuGenServiceProvider serviceProvider)
		{
			...
			SetPadding(this.FlatStyle);
			FlatStyleChanged += delegate
			{
				SetPadding(FlatStyle);
			};
