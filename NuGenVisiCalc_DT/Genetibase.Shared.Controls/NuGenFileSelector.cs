...
namespace Genetibase.Shared.Controls
{
	...
	/// </summary>
	[Designer("Genetibase.Shared.Controls.Design.NuGenFileSelectorDesigner")]
	[ToolboxItem(false)]
	[System.ComponentModel.DesignerCategory("Code")]
	public abstract partial class NuGenFileSelector : UserControl
	{
		...
		public string GetPath
		{
			get 
			{
				return _pathComboBox.Items.Count > 0 ? _pathComboBox.Items[0].ToString() : "";
			}
		}
		...
		{
			if (!NuGenFileSelector.ContainsItem(_pathComboBox, value)) 
			{
				_pathComboBox.Items.Insert(0, value);
				_pathComboBox.Text = value;
		...
		public void LoadConfig(XmlTextReader xmlTextReader)
		{
				...
				)
			{
				while (xmlTextReader.Read()) 
				{
					...
					{
						_pathComboBox.Items.Add(xmlTextReader.ReadString());
					}
				}
			}
			...
			{
				_pathComboBox.Text = _pathComboBox.Items[0].ToString();
			}
		}
		...
		public void SaveConfig(XmlTextWriter xmlTextWriter)
		{
			...
			foreach (string path in _pathComboBox.Items) 
			{
		...
		private static bool ContainsItem(ComboBox comboBox, object item)
		{
		...
		/// </summary>
		protected NuGenFileSelector()
		{
			this.InitializeComponent();
			this.InitializeFileDialog();
			_browseButton.Text = Resources.Text_FileSelector_browseButton;
		}		
	}
}
