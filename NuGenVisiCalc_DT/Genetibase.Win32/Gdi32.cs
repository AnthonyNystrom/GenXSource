...
namespace Genetibase.WinApi
{
	...
	public static class Gdi32
	{
		...
		/// AC_SRC_OVER.</param>
		/// <returns></returns>
		[DllImport(DLL, EntryPoint = "GdiAlphaBlend")]
		...
		/// <returns>If the function succeeds, the return value is the handle to the region. If the function fails, the return value is <c>IntPtr.Zero</c>.</returns>
		[DllImport(DLL)]
