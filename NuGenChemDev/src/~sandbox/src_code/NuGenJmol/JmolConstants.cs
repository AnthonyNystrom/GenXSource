...
namespace Org.Jmol.Viewer
{
    sealed public class JmolConstants
    {
        ...
        public const string copyright = "(C) 2006 Jmol Development";
        public const string version = "10.2.0";
        public const string cvsDate = "$Date: 2006-04-14 20:06:13 +0200 (ven., 14 avr. 2006) $";
        ...
        public static readonly string date = cvsDate.Substring(7, (23) - (7));
        ...
        public static readonly string[] pickingModeNames = new string[] { "off", "ident", "distance", "monitor", "angle", "torsion", "label", "center", "coord", "bond", "atom", "group", "chain" };
        ...
        internal static readonly string[] bondOrderNames = new string[] { "single", "double", "triple", "aromatic", "hbond", "partial", "partialDouble" };
        ...
        /// </returns>
        public static sbyte elementNumberFromSymbol(string elementSymbol)
        {
        ...
        public static readonly string[] alternateElementNames = new string[] { "dummy", "aluminium", "sulphur", "caesium" };
        ...
        public static readonly int[] argbsChainHetero = new int[] { unchecked((int)0xFFffffff), unchecked((int)0xFFC0D0FF - 0x00303030), unchecked((int)(0xFFB0FFB0 - 0x00303018)), unchecked((int)(0xFFFFC0C8 - 0x00303018)), unchecked((int)(0xFFFFFF80 - 0x00303010)), unchecked((int)(0xFFFFC0FF - 0x00303030)), unchecked((int)(0xFFB0F0F0 - 0x00303030)), unchecked((int)(0xFFFFD070 - 0x00303010)), unchecked((int)(0xFFF08080 - 0x00303010)), unchecked((int)(0xFFF5DEB3 - 0x00303030)), unchecked((int)(0xFF00BFFF - 0x00001830)), unchecked((int)(0xFFCD5C5C - 0x00181010)), unchecked((int)(0xFF66CDAA - 0x00101818)), unchecked((int)(0xFF9ACD32 - 0x00101808)), unchecked((int)(0xFFEE82EE - 0x00301030)), unchecked((int)(0xFF00CED1 - 0x00001830)), unchecked((int)(0xFF00FF7F - 0x00003010)), unchecked((int)(0xFF3CB371 - 0x00081810)), unchecked((int)(0xFF00008B + 0x00000030)), unchecked((int)(0xFFBDB76B - 0x00181810)), unchecked((int)(0xFF006400 + 0x00003000)), unchecked((int)(0xFF800000 + 0x00300000)), unchecked((int)(0xFF808000 + 0x00303000)), unchecked((int)(0xFF800080 + 0x00300030)), unchecked((int)(0xFF008080 + 0x00003030)), unchecked((int)(0xFFB8860B + 0x00303008)), unchecked((int)(0xFFB22222 + 0x00101010)) };
        ...
        */
        ...
        public static readonly string[] predefinedGroup3Names = new string[] { "", "ALA", "ARG", "ASN", "ASP", "CYS", "GLN", "GLU", "GLY", "HIS", "ILE", "LEU", "LYS", "MET", "PHE", "PRO", "SER", "THR", "TRP", "TYR", "VAL", "ASX", "GLX", "UNK", "A", "+A", "G", "+G", "I", "+I", "C", "+C", "T", "+T", "U", "+U", "1MA", "AMO", "5MC", "OMC", "1MG", "2MG", "M2G", "7MG", "G7M", "OMG", "YG", "QUO", "H2U", "5MU", "4SU", "PSU", "AMP", "ADP", "ATP", "GMP", "GDP", "GTP", "IMP", "IDP", "ITP", "CMP", "CDP", "CTP", "TMP", "TDP", "TTP", "UMP", "UDP", "UTP", "HOH", "DOD", "WAT", "PO4", "SO4" };
        ...
        public static readonly string[] shapeClassBases = new string[] { "Balls", "Sticks", "Hsticks", "Sssticks", "Labels", "Vectors", "Measures", "Dots", "Backbone", "Trace", "Cartoon", "Strands", "MeshRibbon", "Ribbons", "Rockets", "Stars", "Axes", "Bbcage", "Uccage", "Frank", "Echo", "Hover", "Pmesh", "Polyhedra", "Sasurface", "Isosurface", "Prueba" };
