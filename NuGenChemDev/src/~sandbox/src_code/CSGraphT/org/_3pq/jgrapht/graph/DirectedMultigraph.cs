...
namespace org._3pq.jgrapht.graph
{
	...
	/// <summary> A directed multigraph. A directed multigraph is a non-simple directed graph
	/// in which loops and multiple edges between any two vertices are permitted.
	/// </summary>
	[Serializable]
	public class DirectedMultigraph:AbstractBaseGraph, DirectedGraph
	{
		private const long serialVersionUID = 3258408413590599219L;
		
		/// <summary> Creates a new directed multigraph.</summary>
		public DirectedMultigraph():this(new EdgeFactories.DirectedEdgeFactory())
		{
		}
