...
* Contributor(s):   -
*
* $Id: Pseudograph.java,v 1.2 2004/11/19 10:05:19 barak_naveh Exp $
*
* Changes
* -------
...
namespace org._3pq.jgrapht.graph
{
	...
	/// <summary> A pseudograph. A pseudograph is a non-simple undirected graph in which both
	...
	/// </summary>
	[Serializable]
	public class Pseudograph:AbstractBaseGraph, UndirectedGraph
	{
		private const long serialVersionUID = 3833183614484755253L;
		
		/// <summary> Creates a new pseudograph.</summary>
		public Pseudograph():this(new EdgeFactories.UndirectedEdgeFactory())
		{
		}
