...
* Contributor(s):   -
*
* $Id: SimpleGraph.java,v 1.2 2004/11/19 10:17:12 barak_naveh Exp $
*
* Changes
* -------
...
namespace org._3pq.jgrapht.graph
{
	...
	/// <summary> A simple graph. A simple graph is an undirected graph for which at most one
	...
	/// </summary>
	[Serializable]
	public class SimpleGraph : AbstractBaseGraph, UndirectedGraph
	{
		private const long serialVersionUID = 3545796589454112304L;
		...
		/// <summary> Creates a new simple graph.</summary>
		public SimpleGraph():this(new EdgeFactories.UndirectedEdgeFactory())
		{
		}
