...
{
    public abstract class RenderingView3D : IRenderingView
    {
...
//    public class RenderingView3D_Orth : RenderingView3D
//    {
//        public RenderingView3D_Orth()
//            : base(Matrix.Identity, Matrix.Identity, Matrix.Identity)
//        {
//        }
//
//        public ViewProjTemplate ViewModeTemplate
//        {
//            get
//            {
...
//    }
    ...
    public class RenderingView3DPer : RenderingView3D
    {
        ...
        public override void SetupProjection(int width, int height)
        {
            this.width = width;
            this.height = height;
            projection = Matrix.PerspectiveFovLH((float)Math.PI / 4.0f, (float)width / (float)height,
                                                 near, far);
        }
