...
{
    /// <summary> Classes implementing this interface must implement this method
    ...
    public interface IChemObjectListener
    {
        ...
        /// </summary>
        /// <param name="event"> a ChemObjectChangeEvent object
        /// </param>
        void stateChanged(IChemObjectChangeEvent ev);
    }
}