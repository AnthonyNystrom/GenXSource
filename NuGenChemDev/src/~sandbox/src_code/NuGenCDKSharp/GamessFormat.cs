...
{
	/// <summary> See <a href="http://www.msg.ameslab.gov/GAMESS/doc.menu.html"></a>
	/// 
	/// </summary>
	/// <cdk.module>  io </cdk.module>
	/// <cdk.set>     io-formats </cdk.set>
	public class GamessFormat : IChemFormatMatcher
	{
		...
		virtual public System.String[] NameExtensions
		{
			get
			{
				return new System.String[]{"gam", "gamin", "inp", "gamout"};
			}
