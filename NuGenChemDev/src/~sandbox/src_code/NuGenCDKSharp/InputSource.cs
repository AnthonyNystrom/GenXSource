...
// $Id: InputSource.java,v 1.1 2000/07/15 00:30:44 dbrownell Exp $
...
namespace Org.Xml.Sax
{
    ...
    public class InputSource
    {
         ...
         * @see #setCharacterStream
         */
        public InputSource(StreamReader byteStream)
        {
         ...
         * @see #setCharacterStream
         */
        //public InputSource(StreamReader characterStream)
        //{
         ...
         * @see java.io.InputStream
         */
        public void setByteStream(StreamReader byteStream)
        {
         ...
         * @see #setByteStream
         */
        public StreamReader getByteStream()
        {
            return byteStream;
        }
         ...
         * @see java.io.Reader
         */
        //public void setCharacterStream(StreamReader characterStream)
        //{
        ...
        private StreamReader byteStream;
