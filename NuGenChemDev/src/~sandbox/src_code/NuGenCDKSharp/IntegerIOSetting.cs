...
namespace Org.OpenScience.CDK.IO.Setting
{
    ...
    {
        virtual public int SettingValue
        {
            get
            {
                return System.Int32.Parse(this.setting);
            }

        }

        public IntegerIOSetting(System.String name, int level, System.String question, System.String defaultSetting)
