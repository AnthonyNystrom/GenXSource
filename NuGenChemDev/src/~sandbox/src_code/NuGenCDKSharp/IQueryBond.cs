...
{
    /// <summary> Defines the abililty to be matched against IBond's. Most prominent application
    ...
    {
        /// <summary> Returns true of the given <code>bond</code> matches this IQueryBond.
        /// 
        /// </summary>
        /// <param name="bond">IBond to match against
        /// </param>
        /// <returns>     true, if this IQueryBond matches the given IBond
        /// </returns>
