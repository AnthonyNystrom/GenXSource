...
namespace Org.OpenScience.CDK.IO
{
    ...
    {
        /// <summary> Reads an IChemObject of type "object" from input. The constructor
        /// of the actual implementation may take a Reader as input to get
        /// a very flexible reader that can read from string, files, etc.
        /// 
        /// </summary>
        /// <param name="object">   the type of object to return
        /// </param>
        /// <returns> returns an object of that contains the content (or 
        /// part) of the input content
        /// 
        /// </returns>
        /// <exception cref="CDKException">it is thrown if
        /// the type of information is not available from 
        /// the input
        /// 
        /// </exception>
        IChemObject read(IChemObject object_Renamed);

        /// <summary> Sets the Reader from which this ChemObjectReader should read
        /// the contents.
        /// </summary>
        void setReader(StreamReader reader);

        /// <summary> Sets the InputStream from which this ChemObjectReader should read
        /// the contents.
        /// </summary>
