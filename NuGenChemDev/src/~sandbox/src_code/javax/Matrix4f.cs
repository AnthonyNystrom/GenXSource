...
namespace javax.vecmath
{
	...
	/// <version>  specification 1.1, implementation $Revision: 1.4 $, $Date: 2001/10/13 04:09:46 $
	/// </version>
	...
	public class Matrix4f
	{
		...
		/*
		* $Log: Matrix4f.java,v $
		* Revision 1.4  2001/10/13 04:09:46  arty
		...
		*/
		...
		/// <summary> Constructs and initializes a Matrix4f from the specified 16
		...
		/// <summary> Sets the values in this Matrix4f equal to the row-major array parameter
		...
		/// <summary> Returns true if the Object o1 is of type Matrix4f and all of the data
		...
		{
			return o1 != null && (o1 is Matrix4f) && equals((Matrix4f) o1);
		}
		...
		private void  set_Renamed(float m00, float m01, float m02, float m03, float m10, float m11, float m12, float m13, float m20, float m21, float m22, float m23, float m30, float m31, float m32, float m33)
		{
