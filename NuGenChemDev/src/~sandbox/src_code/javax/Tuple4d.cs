...
namespace javax.vecmath
{
	...
	public abstract class Tuple4d
	{
		...
		*/
		...
		/// <summary> Constructs and initializes a Tuple4d from the specified xyzw coordinates.</summary>
		...
		/// <summary> Constructs and initializes a Tuple4d from the specified array.</summary>
		...
		/// <param name="w">the w coordinate
		/// </param>
		public void  set_Renamed(double x, double y, double z, double w)
		{
			this.x = x;
			this.y = y;
			this.z = z;
		...
		/// <summary> Returns a string that contains the values of this Tuple4d. The form is (x,y,z,w).</summary>
