...
namespace javax.vecmath
{
	...
	/// <summary> A 3 element vector that is represented by double precision floating point
	...
	public class Vector3d:Tuple3d
	{
		...
		*/
		...
		/// <summary> Constructs and initializes a Vector3d from the specified xyz coordinates.</summary>
		...
		/// <summary> Constructs and initializes a Vector3d from the specified array of length 3.</summary>
		...
		public double angle(Vector3d v1)
		{
			...
			return System.Math.Abs(System.Math.Atan2(cross, dot(v1)));
		}
	}
}