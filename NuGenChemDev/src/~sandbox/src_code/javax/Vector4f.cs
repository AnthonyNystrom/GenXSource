...
namespace javax.vecmath
{
	...
	/// <summary> A 4 element vector that is represented by single precision floating point
	/// x,y,z,w coordinates.
	/// </summary>
	...
	public class Vector4f:Tuple4f
	{
		...
		*/
		...
		/// <summary> Constructs and initializes a Vector4f from the specified xyzw coordinates.</summary>
		...
		/// <summary> Constructs and initializes a Vector4f from the specified array of length 4.</summary>
		...
		/// <param name="v1">the Vector4f containing the initialization x y z w data
		/// </param>
		...
		public float angle(Vector4f v1)
		{
			...
			//UPGRADE_WARNING: Data types in Visual C# might be different.  Verify the accuracy of narrowing conversions. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1042'"
			return (float) System.Math.Acos(d / v1_length / v_length);
		}
	}
}