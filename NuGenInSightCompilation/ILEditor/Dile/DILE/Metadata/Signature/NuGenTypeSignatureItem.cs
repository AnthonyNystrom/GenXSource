...
{
	public class NuGenTypeSignatureItem : NuGenBaseTokenSignatureItem
	{
		...
		private List<NuGenCustomModifier> customModifiers = null;
		public List<NuGenCustomModifier> CustomModifiers
		{
			get
			{
