...
{
	public class NuGenArraySignatureItem : NuGenBaseSignatureItem
	{
		private NuGenTypeSignatureItem type;
		public NuGenTypeSignatureItem Type
		{
			get
			{
				return type;
		...
		public NuGenArraySignatureItem()
		{
		}
