...
{
	public class NuGenFontSettingsDisplayer : NuGenBaseSettingsDisplayer
	{
		...
		private void CreatePanelsComboBox(TableLayoutPanel panel)
		{
			...
			foreach (NuGenIChangebleFont changebleFont in NuGenSettings.Instance.Panels)
			{
				PanelsComboBox.Items.Add(changebleFont);
			}

			PanelsComboBox.Items.Add(NuGenSettings.Instance.CodeEditorFont);
		...
		{
			foreach (NuGenIChangebleFont changebleFont in panelsComboBox.Items)
			{
		...
		{
			NuGenIChangebleFont changebleFont = panelsComboBox.SelectedItem as NuGenIChangebleFont;
		...
		private void changeFontButton_Click(object sender, EventArgs e)
		{
			...
			if (changebleFont != null)
			{
				...
				{
					changebleFont.TempFont = new NuGenSerializableFont(fontDialog.Font);
