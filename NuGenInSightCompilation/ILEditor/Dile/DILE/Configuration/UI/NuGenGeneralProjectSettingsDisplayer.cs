...
{
	public class NuGenGeneralProjectSettingsDisplayer : NuGenBaseSettingsDisplayer
	{
		...
		private void CreateProjectNameControls(TableLayoutPanel panel)
		{
			...
			ProjectNameTextBox.Text = NuGenProject.Instance.Name;
		...
		{
			NuGenProject.Instance.Name = ProjectNameTextBox.Text;
		}
