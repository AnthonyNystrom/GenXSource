namespace Dile.UI
{
	partial class NuGenQuickSearchPanel
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.foundItemsList = new Dile.Controls.NuGenCustomListView();
			...
			this.foundItemsList.MultiSelect = false;
		...
		private Dile.Controls.NuGenCustomListView foundItemsList;
