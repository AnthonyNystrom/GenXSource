...
public class RecordStoreWrapper
{
	...
	if (recordStoreName == null)
	    throw new IllegalArgumentException("recordStoreName cannot be null.");
	if ("".equals(recordStoreName))
	    throw new IllegalArgumentException("recordStoreName cannot be an empty string.");
