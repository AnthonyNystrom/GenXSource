 ...
 * @author zyl
 */
public class WorkerThread extends AbstractErrorManager implements Queue, Deallocatable {
                ...
                if (task != null)
                    try {
        				...
        				fireError(e.getMessage(), 
        						new ErrorEvent(this, new RuntimeException("WorkerThread task failed"+e.getMessage()),
     								"Operation failed", task.getType()));
