...
import n2f.sup.common.file.FileSourceWrapper;
import n2f.sup.common.file.FileUtils;
import n2f.sup.common.utils.GraphicsUtils;
import n2f.sup.common.utils.LinkedHashTable;
import n2f.sup.common.utils.Properties;
...
//			}
	...
	public byte[] getImageForSend(String imgName) {
		...
		if (is != null) {
			...
			try {
				is.read(ret);
				this.imageCreationDate = streamWrapper.getCreationDate();
			} catch (IOException e) {
...
//		}
	...
	public long getImageCreationDate() {
		return imageCreationDate;
	}

	public void setImageCreationDate(long imageCreationDate) {
