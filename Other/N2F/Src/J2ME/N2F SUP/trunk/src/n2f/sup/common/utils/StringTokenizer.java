    ...
    public static String parseDate(String timeStr) {
     ...
     public static String getServiceDate(long date) {
   	 ...
   	 private static String formatString(Calendar c) {
    	  StringBuffer sb = new StringBuffer();
    	  String time = c.get(Calendar.DATE) < 10? ZERO+c.get(Calendar.DATE):String.valueOf(c.get(Calendar.DATE));
    	  sb.append(time).append(DOT);
    	  time = c.get(Calendar.MONTH) < 9? ZERO+(c.get(Calendar.MONTH)+1):String.valueOf(c.get(Calendar.MONTH)+1);
    	  sb.append(time).append(DOT);
    	  sb.append(c.get(Calendar.YEAR)).append(SPACE);
    	  time = c.get(Calendar.HOUR_OF_DAY) < 10? ZERO+c.get(Calendar.HOUR_OF_DAY):String.valueOf(c.get(Calendar.HOUR_OF_DAY));
    	  sb.append(time).append(COLUMN);
    	  time = c.get(Calendar.MINUTE) < 10? ZERO+c.get(Calendar.MINUTE):String.valueOf(c.get(Calendar.MINUTE));
    	  sb.append(time).append(COLUMN);
    	  time = c.get(Calendar.SECOND) < 10? ZERO+c.get(Calendar.SECOND):String.valueOf(c.get(Calendar.SECOND));
    	  sb.append(time);
