...
import genetibase.java.security.params.ParametersWithRandom;
    ...
    extends BufferedBlockCipher
{
    ...
    /**
     * Creates a buffered block cipher with the desired padding.
     *
    ...
    /**
     * Creates a buffered block cipher PKCS7 padding.
     * @param cipher the underlying block cipher this buffering object wraps.
     */
    public PaddedBufferedBlockCipher(
        BlockCipher     cipher)
    ...
    /**
     * Returns the minimum size of the output buffer required for an update
    ...
    /**
     * Processes the last block in the buffer. If the buffer is currently
     ...
     * @return	The number of output bytes copied to out.
     * @exception   DataLengthException if there is insufficient space in
     *		    <tt>out</tt> for the output or we are decrypting and the
