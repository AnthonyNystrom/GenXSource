	...
	implements CommandListener, ItemStateListener, IDeviceDiscovererListener
{
	...
	if (App.getCurrentApp().getWebServiceIteractor().getEncryptionKey() != null)
	{
	    ...
	    DeviceDiscoverer discoverer = App.getCurrentApp().getDeviceDiscoverer(this);
	    //TODO: test!
	    if (!value)	discoverer.unregisterPushConnection();
	    discoverer.setVisible(value);
    ...
    private Command _settingsCommand, _inviteCommand;
