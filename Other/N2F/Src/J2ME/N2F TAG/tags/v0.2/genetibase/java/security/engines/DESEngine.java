...
package genetibase.java.security.engines;
    ...
    implements BlockCipher
{
    ...
    /**
     * Creates a new instance of DESEngine.
     */
    public DESEngine()
    {
    }
    ...
    /**
     * Initializes a DES cipher.
     *
     * @param encrypting    Specifies whether or not we are for encryption.
     * @param params	    Specifies the parameters required to set up the cipher.
     * @exception   IllegalArgumentException if <tt>params</tt> is inappropriate.
     */
    public void init(
        boolean           encrypting,
...
//        };
    ...
    /**
     * Generates an integer based working key based on our secret key
