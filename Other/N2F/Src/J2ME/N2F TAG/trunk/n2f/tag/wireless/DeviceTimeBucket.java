...
public class DeviceTimeBucket
{
    ...
    /**
     * Creates a new instance of DeviceTimeBucket.
     *
     * @param remoteDevice  Specifies the RemoteDevice to associate with this
     *			    bucket.
     * @param discoveryTime Specifies the time when the device was discovered.
     */
