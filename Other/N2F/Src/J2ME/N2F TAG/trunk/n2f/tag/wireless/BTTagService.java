...
public final class BTTagService
{
	...
	{
    			Debug.println("closeConnection exception:"+ignored.getMessage());
	...
	{
	    inputStream.close();
	    Debug.println("closed input");

	}
	catch (Exception ignored)
	{
    			Debug.println("closeInputStream exception:"+ignored.getMessage());
    			ignored.printStackTrace();
    		} finally {
    			inputStream = null;
    		}
	...
	{
	    outputStream.close();
	    Debug.println("closed output");
	}
	catch (Exception ignored)
	{
    			Debug.println("closeOutputStream exception:"+ignored.getMessage());
    			ignored.printStackTrace();
    		} finally {
    			outputStream = null;
	}
	...
	catch (IOException ioException)
	{
		...
		System.out.println("device friendly name can't be retrieved, use:"+name);
	}
