...
import n2f.blogger.ui.AbstractWindow;
	...
	implements CommandListener
{
    ...
    private static Font font = Font.getFont(Font.FACE_MONOSPACE,
...
//	private Displayable previousForm;
	...
	form.addCommand(gc = new Command("Garbage collection...", Command.ITEM,
					 3));
    ...
    public void show()
    {
	getInstance().display = Display.getDisplay(App.getCurrentApp());
