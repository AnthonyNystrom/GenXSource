...
import genetibase.java.microedition.componentmodel.RecordStoreWrapper;
 ...
 */
public final class Settings implements Resoursable, Deallocatable
{
    /* ------ Methods.Public ------ */
	...
	try
	{
	    _recordStoreWrapper = new RecordStoreWrapper("N2F_BLOGGER_SETTINGS");
	...
	private SystemStorage systemStorage = null;
