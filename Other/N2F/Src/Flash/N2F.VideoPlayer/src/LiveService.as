package
{
	...
	public class LiveService
	{
		...
		public function Start( onPhotoResponse : Function, onVideoResponse : Function ) : void
		{
			...
			if ( onVideoResponse != null ) StartVideoPoll( onVideoResponse );
			if ( onPhotoResponse != null ) GetProfilePhoto( onPhotoResponse );
		}
		...
		public function GetProfilePhoto( onPhotoResponse : Function ) : void
		{
			...
			var onConnect : Function = function( e : Event ) : void
			{
				...
				var onResponse : Function = function( xml : XML ) : void
				{
					...
					onPhotoResponse( res.length() > 0 ? res[ 0 ].text() : null );
				};
