...
#ifndef __AAFFILEBROWSERENGINE_H__
#define __AAFFILEBROWSERENGINE_H__
...
public: // New functions
	...
	*/
	...
	// ---------------------------------------------------------
	// Retrieves file path of the item with specified index
	// ---------------------------------------------------------
	//
	TFileName GetFileNameL(TInt aPosition);

	// ---------------------------------------------------------
	// Retrieves file description (view without folders)
	// ---------------------------------------------------------
	//
...
private: //Data
	...
	//////////////////////////////////////////////////////////////////////////
	// !New added code
	TFileName iCurrentDirectory; // Currently opened directory
	...
	RArray<TEntry> iCurrentFiles; // List of files in the current directory	
	//////////////////////////////////////////////////////////////////////////
...
#endif // __AAFFILEBROWSERENGINE_H__
