...
============================================================================
*/
#ifndef __AAFIMAGEHANDLER_H__
#define __AAFIMAGEHANDLER_H__
...
class CAafImageHandler : public CActive
    {
public:
	// Construction
	CAafImageHandler(CFbsBitmap& aBitmap, RFs& aFs, MRequestObserver& aCallback);
    void ConstructL();
	~CAafImageHandler();
