/* soapMemberServicesSoap12Proxy.h
...
#ifndef soapMemberServicesSoap12Proxy_H
#define soapMemberServicesSoap12Proxy_H
#include "soapH.h"

class SOAP_CMAC MemberServicesSoap12Proxy : public soap
{ public:
	/// Endpoint URL of service 'MemberServicesSoap12Proxy' (change as needed)
	const char *soap_endpoint;
	/// Constructor
	MemberServicesSoap12Proxy();
	/// Constructor with copy of another engine state
	MemberServicesSoap12Proxy(const struct soap&);
	/// Constructor with engine input+output mode control
	MemberServicesSoap12Proxy(soap_mode iomode);
	/// Constructor with engine input and output mode control
	MemberServicesSoap12Proxy(soap_mode imode, soap_mode omode);
	/// Destructor frees deserialized data
	virtual	~MemberServicesSoap12Proxy();
	/// Initializer used by constructor
	virtual	void MemberServicesSoap12Proxy_init(soap_mode imode, soap_mode omode);
