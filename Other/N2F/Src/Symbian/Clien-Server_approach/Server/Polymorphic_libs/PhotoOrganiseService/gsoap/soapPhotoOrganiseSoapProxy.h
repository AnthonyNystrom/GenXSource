...
#ifndef soapPhotoOrganiseSoapProxy_H
#define soapPhotoOrganiseSoapProxy_H
#include "soapH.h"

class SOAP_CMAC PhotoOrganiseSoapProxy : public soap
{ public:
	/// Endpoint URL of service 'PhotoOrganiseSoapProxy' (change as needed)
	const char *soap_endpoint;
	/// Constructor
	PhotoOrganiseSoapProxy();
	/// Constructor with copy of another engine state
	PhotoOrganiseSoapProxy(const struct soap&);
	/// Constructor with engine input+output mode control
	PhotoOrganiseSoapProxy(soap_mode iomode);
	/// Constructor with engine input and output mode control
	PhotoOrganiseSoapProxy(soap_mode imode, soap_mode omode);
	/// Destructor frees deserialized data
	virtual	~PhotoOrganiseSoapProxy();
	/// Initializer used by constructor
	virtual	void PhotoOrganiseSoapProxy_init(soap_mode imode, soap_mode omode);
