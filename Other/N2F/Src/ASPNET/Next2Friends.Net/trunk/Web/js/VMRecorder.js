function VMRecorder( config, VMToken, newQueryParams, newAffiliateId, newVideoUrl, newPreviewBid )
{
    this.width = "100%";
    this.height = "100%";
    this.target = null;
    this.rootFile = "VMRecorder.swf";
    this.autoPlay = null;
    this.token = VMToken;
    this.URL = this.rootFile + '?token=' + this.token + "&wmode=transparent"
...
VMRecorder.prototype.isValueSet = function( value ) {
    if ( value == null
      || value == 'null'
