<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SymbianDownload.aspx.cs" Inherits="SymbianDownload" %>
...
<body>
    ...
    <div>
    <span class='downloadlink'>Download Live <a style='font-size:smaller' href='/3'>.Sisx </a><small>Live v1.0 (455k)</small></span><br />
