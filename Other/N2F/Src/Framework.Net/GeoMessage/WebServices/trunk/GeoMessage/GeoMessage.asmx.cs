...
using Next2Friends.GeoMessage.Data;
using Next2Friends.GeoMessage.Databases;
using Next2Friends.GeoMessage.Properties;
using Next2Friends.GeoMessage.Tables;
...
namespace Next2Friends.GeoMessage
{
    ...
    [ToolboxItem(false)]
    public class GeoMessage : WebService
    {
        /// <summary>
        ...
        [WebMethod(
            Description = "Unsubscribes the specified user from the message with the specified <tt>messageID</tt>. Can be safely called several times. If the user exists and the message with the specified <tt>memberID</tt> exists, no exceptions will be thrown if the user is already unsubscribed from the message or was never subscribed to." +
            "<br/><b>Params:</b>" +
            "<br/><tt>webMemberID</tt> - Specifies the user identifier." +
            "<br/><tt>password</tt> - Specifies the user password." +
            "<br/><tt>messageID</tt> - Specifies the identifier of the message to remove." +
