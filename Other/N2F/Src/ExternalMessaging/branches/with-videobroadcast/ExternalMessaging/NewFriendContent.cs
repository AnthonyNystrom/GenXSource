...
{
    public class NewFriendContent
    {

        //Enter existing table or view for the target and uncomment the attribute line
        [Microsoft.SqlServer.Server.SqlTrigger(Name = "NewBlog_Friends", Target = "BlogEntry", Event = "FOR INSERT")]
        ...
        //Enter existing table or view for the target and uncomment the attribute line
        [Microsoft.SqlServer.Server.SqlTrigger(Name = "NewVideo_Friends", Target = "Video", Event = "FOR UPDATE")]
        public static void NewVideoFriends()
        {
            SqlTriggerContext triggContext = SqlContext.TriggerContext;
            SqlCommand command = null;
        ...
        /// </summary>
        /// <returns></returns>
        private static DataSet GetFriendMembers(int MemberID,SqlConnection conn)
        {
            SqlCommand command = new SqlCommand("HG_GetAllFriendsByMemberIDWithJoin", conn);
