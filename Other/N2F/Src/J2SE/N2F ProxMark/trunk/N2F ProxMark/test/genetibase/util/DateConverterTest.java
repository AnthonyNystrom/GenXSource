...
public final class DateConverterTest
{
	...
	assertEquals(0L, timeInterval.getHours());
	assertEquals(0L, timeInterval.getMinutes());
	assertEquals(0L, timeInterval.getSeconds());
    }
	...
	assertEquals(0L, timeInterval.getHours());
	assertEquals(0L, timeInterval.getMinutes());
	assertEquals(2L, timeInterval.getSeconds());
    }
