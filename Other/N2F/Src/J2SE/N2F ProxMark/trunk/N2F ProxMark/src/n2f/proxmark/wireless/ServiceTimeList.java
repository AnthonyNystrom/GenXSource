...
public class ServiceTimeList
{
     ...
     * its size by one.
     *
     * @param bucket	Specifies the ServiceTimeBucket to add.
     */
    public void addBucket(ServiceTimeBucket bucket)
    {
	_internalList.addElement(bucket);
    }
    
    /**
     * Returns the ServiceTimeBucket at the specified index.
     *
     * @param index Specifies the index in this list to locate the ServiceTimeBucket at.
     * @return	The ServiceTimeBucket at the specified index.
     * @throws	ArrayIndexOutOfBoundsException if the specified <tt>index</tt>
     *		is invalid.
     */
    public ServiceTimeBucket bucketAt(int index)
    {
	Object element = _internalList.elementAt(index);
	
	if (element != null)
	{
	    return (ServiceTimeBucket)element;
	}
     ...
     */
    public IServiceTimeBucketEnumeration buckets()
    {
	return new ServiceTimeBucketEnumeration(_internalList.elements());
    }
     ...
     */
    public boolean contains(ServiceTimeBucket bucket)
    {
     ...
     *		<code>null</code>.
     */
    public void copyTo(ServiceTimeBucket[] array)
    {
	if (array == null)
	{
     ...
     */
    public ServiceTimeBucket firstBucket()
    {
     ...
     */
    public int indexOf(ServiceTimeBucket bucket)
    {
     ...
     */
    public void insertBucketAt(ServiceTimeBucket bucket, int index)
    {
     ...
     */
    public ServiceTimeBucket lastBucket()
    {
     ...
     */
    public boolean removeBucket(ServiceTimeBucket bucket)
    {
    ...
    /**
     * Creates a new instance of ServiceTimeList.
     */
     ...
     * Creates a new instance of ServiceTimeList.
     */
    public ServiceTimeList(int initialCapacity)
    {
