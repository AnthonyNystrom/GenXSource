...
public class RemoteDeviceHashtable
{
     ...
     *
     * @param	remoteDevice
     *		Specifies the device to search for.
    ...
    /**
     * Creates a new instance of the <tt>RemoteDeviceHashtable</tt> class.
     */
    ...
    /** 
     * Creates a new instance of the <tt>StringHashtable</tt> class.
     *
     * @param	initialCapacity
     *		Specifies the initial capacity for the hashtable.
     * @throws	IllegalArgumentException
     *		If the specified <tt>initialCapacity</tt> is less than zero.
     */
