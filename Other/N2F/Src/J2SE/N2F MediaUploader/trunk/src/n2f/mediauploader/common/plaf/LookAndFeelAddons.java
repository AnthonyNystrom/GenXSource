...
import n2f.mediauploader.common.painter.Painter;
...
import n2f.mediauploader.common.plaf.windows.WindowsClassicLookAndFeelAddons;
import n2f.mediauploader.common.plaf.windows.WindowsLookAndFeelAddons;
import n2f.mediauploader.environment.OS;
 ...
 * <code>LookAndFeelAddons.setAddon("n2f.mediauploader.common.plaf.windows.WindowsLookAndFeelAddons");</code>.
 * 
...
public abstract class LookAndFeelAddons
{
	...
	for (int i = keysAndValues.length - 2; i >= 0; i = i - 2)
	{
	    ...
	    {
		UIManager.getLookAndFeelDefaults().put(keysAndValues[i],
						       keysAndValues[i + 1]);
	    }
	}
    }
	...
	else
	{
	    ...
	    {
		createUIMethod =
			realUIClass.getMethod("createUI",
	    ...
	    try
	    {
		return (ComponentUI)createUIMethod.invoke(null,
	...
	try
	{
	    ...
	    Method setter = clazz.getMethod("setBackgroundPainter",
					    Painter.class);
