#ifndef __FRAMEWORK_ENCODER_OBJECT_SYMBIAN__
#define __FRAMEWORK_ENCODER_OBJECT_SYMBIAN__
...
class EncoderObjectSis : public EncoderObject
{
public:
	EncoderObjectSis(/*EncoderObjectListener *aListener*/);
	virtual ~EncoderObjectSis();
