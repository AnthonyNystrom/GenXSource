//-----------------------------------------------------------------------------
// GLStereoPlayerView.cpp : Implementation of the CGLStereoPlayerView class
//
...
#define CGLStereoPlayerCtrl CGLStereoPlayerView
#define COleControl CView
...
IMPLEMENT_DYNCREATE(CGLStereoPlayerView, CView)

BEGIN_MESSAGE_MAP(CGLStereoPlayerView, CView)
    //{{AFX_MSG_MAP(CGLStereoPlayerView)
    ON_WM_CREATE()
    ON_WM_DESTROY()
    ON_WM_ERASEBKGND()
    ON_WM_SIZE()
...
/////////////////////////////////////////////////////////////////////////////
// CGLStereoPlayerView construction/destruction

CGLStereoPlayerView::CGLStereoPlayerView()
{
	...
	m_stereoPlayer = ((CGLStereoPlayerApp*)AfxGetApp())->GetPlayer();
	m_slideShow = ((CGLStereoPlayerApp*)AfxGetApp())->GetSlideShow();
}
...
/////////////////////////////////////////////////////////////////////////////
// CGLStereoPlayerView drawing

void CGLStereoPlayerView::OnDraw(CDC* pDC)
{
    CGLStereoPlayerDoc* pDoc = GetDocument();
    ASSERT_VALID(pDoc);
...
/////////////////////////////////////////////////////////////////////////////
// CGLStereoPlayerView diagnostics

#ifdef _DEBUG
void CGLStereoPlayerView::AssertValid() const
{
    CView::AssertValid();
}

void CGLStereoPlayerView::Dump(CDumpContext& dc) const
{
    CView::Dump(dc);
}

CGLStereoPlayerDoc* CGLStereoPlayerView::GetDocument() // non-debug version is inline
{
    ASSERT(m_pDocument->IsKindOf(RUNTIME_CLASS(CGLStereoPlayerDoc)));
    return (CGLStereoPlayerDoc*)m_pDocument;
}
#endif //_DEBUG

/////////////////////////////////////////////////////////////////////////////
// Copy from GLStereoPlayerCtrl.cpp ...
...
// Copied from GLStereoPlayerCtrl.cpp
/////////////////////////////////////////////////////////////////////////////
