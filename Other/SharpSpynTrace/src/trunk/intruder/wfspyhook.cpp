...
using namespace Genetibase::Debug;
...
void NuGenHookInstaller::InjectAssembly(int processID, int threadID, String* assemblyLocation, String* typeName, Byte additionalData[])
{
